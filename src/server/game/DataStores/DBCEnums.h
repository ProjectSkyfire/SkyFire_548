...
enum class BattlegroundBracketId                             // bracketId for level ranges
{
...
enum AchievementCriteriaAdditionalCondition
{
    ...
    //ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_BATTLE_PET_FAMILY           = 78, // NYI
    //ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_BATTLE_PET_HEALTH_PCT       = 79, // NYI
    //ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_BATTLE_PET_ENTRY            = 81, // NYI
    //ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_BATTLE_PET_BREED_QUALITY_ID = 89, // NYI
    //ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_PET_BATTLE_IS_PVP           = 90, // NYI
    //ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_BATTLE_PET_SPECIES          = 91, // NYI
};
