...
void LoadDB2Stores(std::string const& dataPath)
{
    ...
    if (!sBroadcastTextStore.LookupEntry(77161)     ||       // last broadcast text added in 5.4.7 (17930)
        !sItemStore.LookupEntry(109014)             ||       // last item added in 5.4.7 (17930)
        !sItemExtendedCostStore.LookupEntry(5268)   ||       // last item extended cost added in 5.4.7 (17930)
        !sSceneScriptStore.LookupEntry(11156))               // last scene script added in 5.4.7 (17930)
    {
        TC_LOG_ERROR("misc", "You have _outdated_ DB2 files, Please extract correct db2 files from client 5.4.7 17930.");
        exit(1);
    }
