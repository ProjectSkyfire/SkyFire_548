    ...
    for (BfCapturePointMap::iterator itr = m_capturePoints.begin(); itr != m_capturePoints.end(); ++itr)
    {
        ...
        switch (itr->second->GetObjectiveState())
        {
            ...
            case BattlefieldObjectiveStates::HORDE:
                ...
                break;
            case BattlefieldObjectiveStates::HORDE_ALLIANCE_CHALLENGE:
            case BattlefieldObjectiveStates::NEUTRAL_ALLIANCE_CHALLENGE:
                team = TEAM_ALLIANCE;
                capturing = true;
                break;
            case BattlefieldObjectiveStates::ALLIANCE_HORDE_CHALLENGE:
            case BattlefieldObjectiveStates::NEUTRAL_HORDE_CHALLENGE:
                team = TEAM_HORDE;
                capturing = true;
                break;
            default:
...
TolBaradCapturePoint::TolBaradCapturePoint(BattlefieldTB* battlefield, TeamId teamInControl) : BfCapturePoint(battlefield)
{
    ...
    m_State = teamInControl == TEAM_ALLIANCE ? BattlefieldObjectiveStates::ALLIANCE : BattlefieldObjectiveStates::HORDE;
}
