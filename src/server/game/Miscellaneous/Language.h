...
enum TrinityStrings
{
    ...
    LANG_BG_BFG_START_TWO_MINUTES = 4444,
    LANG_BG_BFG_START_ONE_MINUTE = 4445,
    LANG_BG_BFG_START_HALF_MINUTE = 4446,
    LANG_BG_BFG_HAS_BEGUN = 4447,
    LANG_BG_BFG_A_NEAR_VICTORY = 4448,
    LANG_BG_BFG_H_NEAR_VICTORY = 4449,

    LANG_BG_BFG_ALLY = 5555,
    LANG_BG_BFG_HORDE = 5556,
    LANG_BG_BFG_NODE_LIGHTHOUSE = 5557,
    LANG_BG_BFG_NODE_MINES = 5558,
    LANG_BG_BFG_NODE_WATERWORKS = 5559,
    LANG_BG_BFG_NODE_TAKEN = 5560,
    LANG_BG_BFG_NODE_DEFENDED = 5561,
    LANG_BG_BFG_NODE_ASSAULTED = 5562,
    LANG_BG_BFG_NODE_CLAIMED = 5563,
