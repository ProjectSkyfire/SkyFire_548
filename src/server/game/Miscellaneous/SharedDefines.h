...
enum class ChatMsg
{
    ...
    CHAT_MSG_TARGET_ICONS                     = 0x17,
    CHAT_MSG_AFK                              = 0x18,
    CHAT_MSG_DND                              = 0x19,
    CHAT_MSG_IGNORED                          = 0x1A,
    CHAT_MSG_SKILL                            = 0x1B,
    CHAT_MSG_LOOT                             = 0x1C,
    CHAT_MSG_CURRENCY                         = 0x1D,
    CHAT_MSG_MONEY                            = 0x1E,
    CHAT_MSG_OPENING                          = 0x1F,
    CHAT_MSG_TRADESKILLS                      = 0x20,
    CHAT_MSG_PET_INFO                         = 0x21,
    CHAT_MSG_COMBAT_MISC_INFO                 = 0x22,
    CHAT_MSG_COMBAT_XP_GAIN                   = 0x23,
    CHAT_MSG_COMBAT_HONOR_GAIN                = 0x24,
    CHAT_MSG_COMBAT_FACTION_CHANGE            = 0x25,
    CHAT_MSG_BG_SYSTEM_NEUTRAL                = 0x26,
    CHAT_MSG_BG_SYSTEM_ALLIANCE               = 0x27,
    CHAT_MSG_BG_SYSTEM_HORDE                  = 0x28,
    CHAT_MSG_RAID_LEADER                      = 0x29,
    CHAT_MSG_RAID_WARNING                     = 0x2A,
    ...
    CHAT_MSG_RESTRICTED                       = 0x31,
    CHAT_MSG_CHANNEL_1                        = 0x32,
    CHAT_MSG_CHANNEL_2                        = 0x33,
    CHAT_MSG_CHANNEL_3                        = 0x34,
    CHAT_MSG_CHANNEL_4                        = 0x35,
    CHAT_MSG_CHANNEL_5                        = 0x36,
    CHAT_MSG_CHANNEL_6                        = 0x37,
    CHAT_MSG_CHANNEL_7                        = 0x38,
