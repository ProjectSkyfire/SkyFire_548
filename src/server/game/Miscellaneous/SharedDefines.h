...
enum class ChatMsg
{
    ...
    CHAT_MSG_REPLY                            = 0x0A,
    CHAT_MSG_EMOTE                            = 0x0B,
    CHAT_MSG_TEXT_EMOTE                       = 0x0C,
    CHAT_MSG_MONSTER_SAY                      = 0x0D,
    CHAT_MSG_MONSTER_PARTY                    = 0x0E,
    CHAT_MSG_MONSTER_YELL                     = 0x0F,
    CHAT_MSG_MONSTER_WHISPER                  = 0x10,
    CHAT_MSG_MONSTER_EMOTE                    = 0x11,
    CHAT_MSG_CHANNEL                          = 0x12,
    CHAT_MSG_CHANNEL_JOIN                     = 0x13,
    CHAT_MSG_CHANNEL_LEAVE                    = 0x14,
    CHAT_MSG_CHANNEL_LIST                     = 0x15,
    CHAT_MSG_CHANNEL_NOTICE                   = 0x16,
    CHAT_MSG_CHANNEL_NOTICE_USER              = 0x17,
    CHAT_MSG_TARGET_ICONS                     = 0x18,
    CHAT_MSG_AFK                              = 0x19,
    CHAT_MSG_DND                              = 0x1A,
    CHAT_MSG_IGNORED                          = 0x1B,
    CHAT_MSG_SKILL                            = 0x1C,
    CHAT_MSG_LOOT                             = 0x1D,
    CHAT_MSG_CURRENCY                         = 0x1E,
    CHAT_MSG_MONEY                            = 0x1F,
    CHAT_MSG_OPENING                          = 0x20,
    CHAT_MSG_TRADESKILLS                      = 0x21,
    CHAT_MSG_PET_INFO                         = 0x22,
    CHAT_MSG_COMBAT_MISC_INFO                 = 0x23,
    CHAT_MSG_COMBAT_XP_GAIN                   = 0x24,
    CHAT_MSG_COMBAT_HONOR_GAIN                = 0x25,
    CHAT_MSG_COMBAT_FACTION_CHANGE            = 0x26,
    CHAT_MSG_BG_SYSTEM_NEUTRAL                = 0x27,
    CHAT_MSG_BG_SYSTEM_ALLIANCE               = 0x28,
    CHAT_MSG_BG_SYSTEM_HORDE                  = 0x29,
    CHAT_MSG_RAID_LEADER                      = 0x2A,
    CHAT_MSG_RAID_WARNING                     = 0x2B,
    CHAT_MSG_RAID_BOSS_WHISPER                = 0x2C,
    CHAT_MSG_RAID_BOSS_EMOTE                  = 0x2D,
    CHAT_MSG_QUEST_BOSS_EMOTE                 = 0x2E,
    CHAT_MSG_FILTERED                         = 0x2F,
    CHAT_MSG_INSTANCE                         = 0x30,
    CHAT_MSG_INSTANCE_LEADER                  = 0x31,
    CHAT_MSG_RESTRICTED                       = 0x32,
    CHAT_MSG_CHANNEL_1                        = 0x33,
    CHAT_MSG_CHANNEL_2                        = 0x34,
    CHAT_MSG_CHANNEL_3                        = 0x35,
    CHAT_MSG_CHANNEL_4                        = 0x36,
    CHAT_MSG_CHANNEL_5                        = 0x37,
    CHAT_MSG_CHANNEL_6                        = 0x38,
    CHAT_MSG_CHANNEL_7                        = 0x39,
    CHAT_MSG_CHANNEL_8                        = 0x3A,
    CHAT_MSG_CHANNEL_9                        = 0x3B,
    CHAT_MSG_CHANNEL_10                       = 0x3C,
    CHAT_MSG_ACHIEVEMENT                      = 0x3D,
    CHAT_MSG_GUILD_ACHIEVEMENT                = 0x3F,
    CHAT_MSG_PARTY_LEADER                     = 0x40,
    CHAT_MSG_BN_WHISPER                       = 0x41,
    CHAT_MSG_BN_WHISPER_INFORM                = 0x42,
    CHAT_MSG_BN_CONVERSATION                  = 0x43,
    CHAT_MSG_BN_CONVERSATION_NOTICE           = 0x44,
    CHAT_MSG_BN_CONVERSATION_LIST             = 0x45,
    CHAT_MSG_BN_ALERT                         = 0x46,
    CHAT_MSG_BN_BROADCAST                     = 0x47,
    CHAT_MSG_BN_BROADCAST_INFORM              = 0x48,
    CHAT_MSG_BN_INLINE_TOAST_ALERT            = 0x49,
    CHAT_MSG_BN_INLINE_TOAST_BROADCAST        = 0x4A,
    CHAT_MSG_BN_INLINE_TOAST_BROADCAST_INFORM = 0x4B,
    CHAT_MSG_BN_INLINE_TOAST_CONVERSATION     = 0x4C,
    CHAT_MSG_BN_WHISPER_PLAYER_OFFLINE        = 0x4D,
    CHAT_MSG_COMBAT_GUILD_XP_GAIN             = 0x4E,
    CHAT_MSG_PET_BATTLE_COMBAT_LOG            = 0x4F,
    CHAT_MSG_PET_BATTLE_INFO                  = 0x50,
    MSG_NULL_ACTION                           = 0x51
};
