...
enum EUnitFields
{
	...
	UNIT_FIELD_BYTES_1 = OBJECT_END + 0x98, // size 1, flags MIRROR_ALL
	UNIT_FIELD_BYTES_2 = OBJECT_END + 0x99, // size 1, flags MIRROR_ALL
	UNIT_END = OBJECT_END + 0x100
};
...
{
	PLAYER_DYNAMIC_FIELD_RESERACH_SITE = 0x0, // maybe special spell ids (visual glyphs, 20113 or 57979)
	PLAYER_DYNAMIC_FIELD_RESEARCH_SITE_PROGRESS = 0x1,
	PLAYER_DYNAMIC_RESEARCH_SITES = 0x2, // 20 fields, 4 per map
	PLAYER_DYNAMIC_UNK_3 = 0x3,
	PLAYER_DYNAMIC_FIELD_DAILY_QUESTS_COMPLETED = 0x4,
