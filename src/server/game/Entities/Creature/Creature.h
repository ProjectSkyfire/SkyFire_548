...
enum CreatureFlagsExtra
{
    ...
    CREATURE_FLAG_EXTRA_ALL_PHASES = 0x00200000,         // Creature is visible in every phase (custom, used by mod-prabowow vendors)
...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_ALL_PHASES)
