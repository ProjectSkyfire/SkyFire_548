...
namespace rbac
{
    ...
    enum RBACPermissions
    {
        ...
        RBAC_PERM_COMMAND_ACCOUNT_CONVERT = 232,
        RBAC_PERM_COMMAND_ACCOUNT_CONVERT_EMAIL = 233,
        //Free 234-238
        ...
        RBAC_PERM_COMMAND_PACKET = 1004,
        RBAC_PERM_COMMAND_PACKET_START = 1005,
        RBAC_PERM_COMMAND_PACKET_STOP = 1006,
        RBAC_PERM_COMMAND_PACKET_CHAR = 1007,
        RBAC_PERM_COMMAND_PACKET_CHAR_START = 1008,
        RBAC_PERM_COMMAND_PACKET_CHAR_STOP = 1009,
        RBAC_PERM_COMMAND_DEBUG_LFG_REQUIREMENTS = 1010,
        RBAC_PERM_COMMAND_DEBUG_LFG_FLEX = 1011,
        RBAC_PERM_COMMAND_ACCOUNT_TWOFACTOR = 1012,
        RBAC_PERM_COMMAND_ACCOUNT_TWOFACTOR_SETUP = 1013,
        RBAC_PERM_COMMAND_ACCOUNT_TWOFACTOR_CONFIRM = 1014,
        RBAC_PERM_COMMAND_ACCOUNT_TWOFACTOR_STATUS = 1015,
        RBAC_PERM_COMMAND_ACCOUNT_TWOFACTOR_DISABLE = 1016,
        RBAC_PERM_COMMAND_ACCOUNT_TWOFACTOR_RESET = 1017,
