...
enum GILNEAS_BG_WorldStates
{
    ...
    ILNEAS_BG_OP_LIGHTHOUSE_STATE_ALLIANCE    = 1767,
...
enum GILNEAS_BG_NodeObjectId
{
    ...
    GILNEAS_BG_OBJECTID_NODE_BANNER_1         = 208785,       // Waterworks banner
    GILNEAS_BG_OBJECTID_NODE_BANNER_2         = 208782,       // Mines banner
};
