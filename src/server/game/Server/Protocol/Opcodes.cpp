...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ADD_FRIEND,                         0x064F, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleAddFriendOpcode              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_ADD_IGNORE,                         0x126D, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleAddIgnoreOpcode              ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AREATRIGGER,                        0x155A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAreaTriggerOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_ATTACKSTOP,                         0x1E13, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAttackStopOpcode             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_ATTACKSWING,                        0x1513, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleAttackSwingOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_AUCTION_HELLO,                      0x047F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionHelloOpcode           ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AUTH_SESSION,                       0x1A51, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess               ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_AUTOBANK_ITEM,                      0x1C42, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoBankItemOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_AUTOEQUIP_ITEM,                     0x166B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoEquipItemOpcode          ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_BAG_ITEM,                 0x162B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoStoreBagItemOpcode       ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_BANK_ITEM,                0x176A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoStoreBankItemOpcode      ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_AUTOSTORE_LOOT_ITEM,                0x1F7A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutostoreLootItemOpcode      ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_AUTO_DECLINE_GUILD_INVITES,         0x0174, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoDeclineGuildInvites      ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_BANKER_ACTIVATE,                    0x02FD, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBankerActivateOpcode         ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BEGIN_TRADE,                        0x0C9A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBeginTradeOpcode             );
    DEFINE_OPCODE_HANDLER(CMSG_BINDER_ACTIVATE,                    0x0477, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBinderActivateOpcode         ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BUYBACK_ITEM,                       0x07D7, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuybackItem                  ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_BUY_BANK_SLOT,                      0x00FE, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuyBankSlotOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_BUY_ITEM,                           0x1077, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBuyItemOpcode                ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_CALENDAR_ADD_EVENT,                 0x16D0, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleCalendarAddEvent             ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CALENDAR_EVENT_INVITE,              0x1551, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleCalendarEventInvite          ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_AURA,                        0x16E1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelAuraOpcode             ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_CAST,                        0x12EB, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleCancelCastOpcode             ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_MOUNT_AURA,                  0x1552, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelMountAuraOpcode        ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_TRADE,                       0x1D32, STATUS_LOGGEDIN_OR_RECENTLY_LOGGOUT, PROCESS_THREADUNSAFE, &WorldSession::HandleCancelTradeOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_CAST_SPELL,                         0x1E5B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleCastSpellOpcode              ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_CREATE,                        0x09B9, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharCreateOpcode             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_CUSTOMIZE,                     0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleCharCustomize                );
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_DELETE,                        0x113B, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharDeleteOpcode             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_CHAR_ENUM,                          0x12C2, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCharEnumOpcode               ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CORPSE_MAP_POSITION_QUERY,          0x0152, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCorpseMapPositionQuery       );
    DEFINE_OPCODE_HANDLER(CMSG_CREATURE_QUERY,                     0x1E72, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleCreatureQueryOpcode          ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_DESTROY_ITEM,                       0x1F12, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDestroyItemOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_DUEL_PROPOSED,                      0x19B3, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleDuelProposedOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_EJECT_PASSENGER,                    0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_EMOTE,                              0x12C5, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleEmoteOpcode                  ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GAMEOBJECT_QUERY,                   0x14EA, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGameObjectQueryOpcode        ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GAMEOBJ_REPORT_USE,                 0x06DF, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGameobjectReportUse          ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GAMEOBJ_USE,                        0x055F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGameObjectUseOpcode          ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GMTICKET_SYSTEMSTATUS,              0x128A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGMTicketSystemStatusOpcode   );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GOSSIP_HELLO,                       0x05F6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGossipHelloOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GOSSIP_SELECT_OPTION,               0x02D7, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGossipSelectOptionOpcode     ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_DISBAND,                      0x0DB2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupDisbandOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_INVITE,                       0x1990, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupInviteOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_INVITE_RESPONSE,              0x1C51, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupInviteResponseOpcode    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_RAID_CONVERT,                 0x19A0, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupRaidConvertOpcode       ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_REQUEST_JOIN_UPDATES,         0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_SET_LEADER,                   0x1383, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupSetLeaderOpcode         ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_SET_ROLES,                    0x1C93, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGroupSetRolesOpcode          ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GROUP_UNINVITE_GUID,                0x0989, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupUninviteGuidOpcode      ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_ACCEPT,                       0x18A3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAcceptOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_ADD_RANK,                     0x1935, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAddRankOpcode           ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANKER_ACTIVATE,              0x02F6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankerActivate          ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_BUY_TAB,                 0x02D6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankBuyTab              ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY,   0x03FC, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankMoneyWithdrawn      ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_BANK_QUERY_TAB,               0x07DC, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankQueryTab            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_DECLINE,                      0x1B05, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDeclineOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_DEL_RANK,                     0x1D3C, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDelRankOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_DEMOTE,                       0x1B1C, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDemoteOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_DISBAND,                      0x190E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildDisbandOpcode           ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_INVITE,                       0x188B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildInviteOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_LEAVE,                        0x193D, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildLeaveOpcode             ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_MOTD,                         0x1DB4, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildMOTDOpcode              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_NEWS_UPDATE_STICKY,           0x1984, STATUS_LOGGEDIN , PROCESS_INPLACE,      &WorldSession::HandleGuildNewsUpdateStickyOpcode  ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_PERMISSIONS,                  0x1D0F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildPermissions             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_PROMOTE,                      0x19B5, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildPromoteOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_QUERY,                        0x1280, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildQueryOpcode             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_QUERY_NEWS,                   0x1D35, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGuildQueryNewsOpcode         ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_QUERY_RANKS,                  0x1BBC, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildQueryRanksOpcode        ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_REMOVE,                       0x1D9F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRemoveOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_ROSTER,                       0x19BC, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildRosterOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SET_GUILD_MASTER,             0x189B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildSetGuildMaster          ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_GUILD_SET_RANK_PERMISSIONS,         0x19BD, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildSetRankPermissionsOpcode); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_INITIATE_TRADE,                     0x12BB, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleInitiateTradeOpcode          );
    DEFINE_OPCODE_HANDLER(CMSG_INSPECT,                            0x01D4, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleInspectOpcode                ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_JOIN_CHANNEL,                       0x1D20, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleJoinChannel                  ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LEARN_TALENT,                       0x1F5A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLearnTalentOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_LEAVE_CHANNEL,                      0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleLeaveChannel                 );
    DEFINE_OPCODE_HANDLER(CMSG_LFG_GET_STATUS,                     0x19AA, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleLfgGetStatus                 );
    DEFINE_OPCODE_HANDLER(CMSG_LFG_JOIN,                           0x18B8, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgJoinOpcode                );
    DEFINE_OPCODE_HANDLER(CMSG_LFG_LEAVE,                          0x0D83, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgLeaveOpcode               );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LFG_PROPOSAL_RESULT,                0x1C99, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgProposalResultOpcode      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LFG_TELEPORT,                       0x1999, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgTeleportOpcode            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LIST_INVENTORY,                     0x10DD, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleListInventoryOpcode          ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_LOAD_SCREEN,                        0x1691, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLoadScreenOpcode             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_LOGOUT_CANCEL,                      0x11D4, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLogoutCancelOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_LOGOUT_REQUEST,                     0x0476, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLogoutRequestOpcode          ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_LOG_DISCONNECT,                     0x1A13, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess               ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_LOOT,                               0x1E52, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootOpcode                   ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LOOT_METHOD,                        0x1C10, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMethodOpcode             ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MAIL_CREATE_TEXT_ITEM,              0x0254, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailCreateTextItem           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MAIL_DELETE,                        0x13A3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailDelete                   ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MAIL_MARK_AS_READ,                  0x027F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailMarkAsRead               ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MAIL_RETURN_TO_SENDER,              0x1C8A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailReturnToSender           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MAIL_TAKE_ITEM,                     0x06F6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailTakeItem                 ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MAIL_TAKE_MONEY,                    0x0676, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMailTakeMoney                ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_AFK,                    0x0422, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_CHANNEL,                0x0904, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_DND,                    0x1E21, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_EMOTE,                  0x0520, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_GUILD,                  0x070B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_OFFICER,                0x1F69, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_PARTY,                  0x0642, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_RAID,                   0x054B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_RAID_WARNING,           0x0423, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_SAY,                    0x0C41, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_WHISPER,                0x0D60, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_YELL,                   0x0C43, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MINIGAME_MOVE,                      0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_MINIMAP_PING,                       0x1A93, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMinimapPingOpcode            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_MOUNTSPECIAL_ANIM,                  0x1F32, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMountSpecialAnimOpcode       ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NAME_QUERY,                         0x0DB3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNameQueryOpcode              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_REALM_NAME_QUERY,                   0x1899, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleRealmNameQueryOpcode         ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_NPC_TEXT_QUERY,                     0x12FA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNpcTextQueryOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_OBJECT_UPDATE_FAILED,               0x0882, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleObjectUpdateFailedOpcode     ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_NAME_QUERY,                     0x16A3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetNameQuery                 ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PING,                               0x1070, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess               ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_PLAYED_TIME,                        0x173A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePlayedTime                   ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_PLAYER_LOGIN,                       0x17D3, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandlePlayerLoginOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_GUILD_REWARDS,                0x171B, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleGuildRewardsQueryOpcode      ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_GUILD_XP,                     0x1D37, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildQueryXPOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_INSPECT_ACHIEVEMENTS,         0x047E, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleQueryInspectAchievements     ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUERY_TIME,                         0x03FD, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryTimeOpcode              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_ACCEPT_QUEST,            0x0356, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverAcceptQuestOpcode  ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_CHOOSE_REWARD,           0x075F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverChooseRewardOpcode ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_COMPLETE_QUEST,          0x115E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverCompleteQuest      ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_HELLO,                   0x1056, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverHelloOpcode        ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_QUERY_QUEST,             0x0474, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverQueryQuestOpcode   ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_REQUEST_REWARD,          0x107E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverRequestRewardOpcode); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY,   0x0275, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestgiverStatusMultipleQuery); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUESTGIVER_STATUS_QUERY,            0x05FD, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleQuestgiverStatusQueryOpcode  ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_QUESTLOG_REMOVE_QUEST,              0x0655, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestLogRemoveQuest          ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUEST_QUERY,                        0x1F52, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQuestQueryOpcode             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_RAID_READY_CHECK,                   0x0D88, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckOpcode         ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_RAID_READY_CHECK_CONFIRM,           0x13D9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRaidReadyCheckConfirmOpcode  ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_RANDOM_ROLL,                        0x1891, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRandomRollOpcode             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_RANDOMIZE_CHAR_NAME,                0x1DB9, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleRandomizeCharNameOpcode      ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_READY_FOR_ACCOUNT_DATA_TIMES,       0x13CB, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleReadyForAccountDataTimes     ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_READ_ITEM,                          0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleReadItem                     );
    DEFINE_OPCODE_HANDLER(CMSG_REALM_SPLIT,                        0x1282, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleRealmSplitOpcode             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_RECLAIM_CORPSE,                     0x065C, STATUS_LOGGEDIN , PROCESS_THREADUNSAFE, &WorldSession::HandleReclaimCorpseOpcode          ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_REDIRECTION_AUTH_PROOF,             0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_REFORGE_ITEM,                       0x1632, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReforgeItemOpcode            );
    DEFINE_OPCODE_HANDLER(CMSG_REORDER_CHARACTERS,                 0x1892, STATUS_AUTHED,    PROCESS_INPLACE,      &WorldSession::HandleReorderCharacters            ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_REPAIR_ITEM,                        0x0577, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRepairItemOpcode             ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_REPOP_REQUEST,                      0x04FC, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRepopRequestOpcode           ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REQUEST_HOTFIX,                     0x16C2, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestHotfix                ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_RESET_INSTANCES,                    0x169B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleResetInstancesOpcode         ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_RETURN_TO_GRAVEYARD,                0x0257, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleReturnToGraveyard            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SEND_MAIL,                          0x01A9, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSendMail                     ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_ACTIONBAR_TOGGLES,              0x03F5, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleSetActionBarToggles          ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_SET_ACTION_BUTTON,                  0x1393, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetActionButtonOpcode        ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_PRIMARY_TALENT_TREE,            0x04AA, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandeSetTalentSpecialization       ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_SELECTION,                      0x10D5, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetSelectionOpcode           ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_TITLE,                          0x13E2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetTitleOpcode               );
    DEFINE_OPCODE_HANDLER(CMSG_SET_TRADE_CURRENCY,                 0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    DEFINE_OPCODE_HANDLER(CMSG_SET_TRADE_GOLD,                     0x0C93, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetTradeGoldOpcode           );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SHOWING_CLOAK,                      0x1276, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleShowingCloakOpcode           ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_SHOWING_HELM,                       0x117F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleShowingHelmOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SPLIT_ITEM,                         0x140A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSplitItemOpcode              ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TAXINODE_STATUS_QUERY,              0x01FF, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTaxiNodeStatusQueryOpcode    );
    DEFINE_OPCODE_HANDLER(CMSG_TAXIQUERYAVAILABLENODES,            0x0656, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTaxiQueryAvailableNodes      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TIME_SYNC_RESP,                     0x0413, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleTimeSyncResp                 ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_UNLEARN_SKILL,                      0x025D, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUnlearnSkillOpcode           ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_USE_ITEM,                           0x15E3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUseItemOpcode                ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_VIOLENCE_LEVEL,                     0x05A0, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleViolenceLevel                ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_WARDEN_DATA,                        0x1681, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleWardenDataOpcode             ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_WHO,                                0x13C1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleWhoOpcode                    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(CMSG_WHOIS,                              0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleWhoisOpcode                  );
    DEFINE_OPCODE_HANDLER(CMSG_WORLD_STATE_UI_TIMER_UPDATE,        0x1CA3, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleWorldStateUITimerUpdate      ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CORPSE_QUERY,                       0x129B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCorpseQueryOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(MSG_MOVE_FALL_LAND,                      0x055B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_HEARTBEAT,                      0x017B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_JUMP,                           0x0438, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_FACING,                     0x005A, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_PITCH,                      0x047A, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_RUN_MODE,                   0x0878, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_WALK_MODE,                  0x0138, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_ASCEND,                   0x0430, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_BACKWARD,                 0x0459, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_DESCEND,                  0x0132, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_FORWARD,                  0x041B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_PITCH_DOWN,               0x093B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_PITCH_UP,                 0x0079, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_LEFT,              0x0873, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_STRAFE_RIGHT,             0x0C12, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_SWIM,                     0x0871, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_TURN_LEFT,                0x011B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_START_TURN_RIGHT,               0x0411, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP,                           0x0570, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_ASCEND,                    0x0012, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_PITCH,                     0x0071, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_STRAFE,                    0x0171, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_SWIM,                      0x0578, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_STOP_TURN,                      0x0530, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes              ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_TELEPORT_ACK,                   0x0978, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveTeleportAck              ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(MSG_MOVE_WORLDPORT_ACK,                  0x18BB, STATUS_TRANSFER,  PROCESS_THREADUNSAFE, &WorldSession::HandleMoveWorldportAckOpcode       ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(MSG_PETITION_DECLINE,                    0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionDeclineOpcode        );
    DEFINE_OPCODE_HANDLER(MSG_PETITION_RENAME,                     0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionRenameOpcode         );
    ...
    DEFINE_OPCODE_HANDLER(MSG_SET_DUNGEON_DIFFICULTY,              0x0000, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetDungeonDifficultyOpcode   );
    ...
    DEFINE_OPCODE_HANDLER(MSG_VERIFY_CONNECTIVITY,                 0x4F57, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess            );
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ACCOUNT_DATA_TIMES,                 0x0F40, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ACTION_BUTTONS,                     0x1768, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_ACTIVATETAXIREPLY,                  0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_ADDON_INFO,                         0x10E2, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ATTACKERSTATEUPDATE,                0x0540, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_ATTACKSTART,                        0x0403, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_ATTACKSTOP,                         0x1448, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AUCTION_HELLO,                      0x04E9, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AURA_UPDATE,                        0x1B8D, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_CHALLENGE,                     0x14B8, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_AUTH_RESPONSE,                      0x15A0, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BINDER_CONFIRM,                     0x0F22, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_BINDPOINTUPDATE,                    0x11E2, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BUY_ITEM,                           0x0763, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CAST_FAILED,                        0x0560, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CHANNEL_NOTIFY,                     0x11C5, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CHARACTER_LOGIN_FAILED,             0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CREATE,                        0x1469, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_CUSTOMIZE,                     0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_DELETE,                        0x1529, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CHAR_ENUM,                          0x040A, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CLEAR_COOLDOWNS,                    0x1926, STATUS_NEVER); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CLIENTCACHE_VERSION,                0x1E41, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CLIENT_CONTROL_UPDATE,              0x01EA, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_COOLDOWN_EVENT,                     0x1C5B, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CORPSE_MAP_POSITION_QUERY_RESPONSE, 0x1C73, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CORPSE_NOT_IN_INSTANCE,             0x1C3B, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CORPSE_QUERY,                       0x1F32, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CORPSE_RECLAIM_DELAY,               0x1E73, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CREATURE_QUERY_RESPONSE,            0x00E0, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_CRITERIA_DELETED,                   0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CRITERIA_UPDATE,                    0x13B2, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DB_REPLY,                           0x1F01, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_DEATH_RELEASE_LOC,                  0x1672, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DESTROY_OBJECT,                     0x1D69, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_EMOTE,                              0x022F, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_FEATURE_SYSTEM_STATUS,              0x1560, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_QUERY_RESPONSE,          0x066A, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GMTICKET_SYSTEMSTATUS,              0x145B, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GOSSIP_MESSAGE,                     0x0E52, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GOSSIP_POI,                         0x058F, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_DECLINE,                      0x108F, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_DESTROYED,                    0x1564, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_INVITE,                       0x1472, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_LIST,                         0x1E61, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_SET_LEADER,                   0x15A2, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_SET_ROLE,                     0x0890, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_BANK_LIST,                    0x1B7B, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_COMMAND_RESULT,               0x1A13, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_INVITE,                       0x185A, STATUS_LOGGEDIN ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_NEWS_UPDATE,                  0x187B, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_PARTY_STATE_RESPONSE,         0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_PERMISSIONS_QUERY_RESULTS,    0x1A32, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_QUERY_RESPONSE,               0x1953, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_RANK,                         0x1271, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_REWARDS_LIST,                 0x1010, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_ROSTER,                       0x1231, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_UPDATE_ROSTER,                0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_XP,                           0x1A51, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_XP_GAIN,                      0x1A11, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_HOTFIX_INFO,                        0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_HOTFIX_NOTIFY,                      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_INITIALIZE_FACTIONS,                0x11E1, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_INITIAL_SPELLS,                     0x1B05, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_INIT_CURRENCY,                      0x1E3A, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_INVENTORY_CHANGE_FAILURE,           0x0F49, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ITEM_PUSH_RESULT,                   0x04A1, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LEARNED_SPELL,                      0x0C99, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LEVELUP_INFO,                       0x0E6A, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LFG_JOIN_RESULT,                    0x12E9, STATUS_NEVER);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LFG_PROPOSAL_UPDATE,                0x0C23, STATUS_NEVER	   );
    DEFINE_OPCODE_HANDLER(SMSG_LFG_QUEUE_STATUS,                   0x0D40, STATUS_NEVER	   );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LIST_INVENTORY,                     0x0D2A, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOAD_CUF_PROFILES,                  0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LOGIN_SETTIMESPEED,                 0x0F4A, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOGIN_VERIFY_WORLD,                 0x0603, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_CANCEL_ACK,                  0x0E0A, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_COMPLETE,                    0x0429, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOGOUT_RESPONSE,                    0x0D2B, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOG_XPGAIN,                         0x1613, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ALL_PASSED,                    0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_CLEAR_MONEY,                   0x0C89, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_MONEY_NOTIFY,                  0x1F49, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_RELEASE_RESPONSE,              0x14A2, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_REMOVED,                       0x0D00, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_RESPONSE,                      0x1F41, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MESSAGECHAT,                        0x0E60, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MINIMAP_PING,                       0x1501, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MONEY_NOTIFY,                       0x05E2, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_MONSTER_MOVE,                       0x12D8, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_MONSTER_MOVE_TRANSPORT,             0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_MOTD,                               0x0E20, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_MOUNTRESULT,                        0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_MOUNTSPECIAL_ANIM,                  0x0E4B, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_ROOT,                          0x198B, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_ACTIVE_MOVER,              0x129A, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_CAN_FLY,                   0x01F4, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_FLIGHT_SPEED,              0x02DC, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_RUN_SPEED,                 0x1B9B, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_SWIM_BACK_SPEED,           0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_SWIM_SPEED,                0x01D4, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_TURN_RATE,                 0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_WALK_SPEED,                0x00A0, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNROOT,                        0x1D8A, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNSET_CAN_FLY,                 0x1D81, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NAME_QUERY_RESPONSE,                0x1E5B, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_REALM_NAME_QUERY_RESPONSE,          0x1652, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_NEW_TAXI_PATH,                      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_NEW_WORLD,                          0x05AB, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_NPC_TEXT_UPDATE,                    0x10E0, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PARTY_COMMAND_RESULT,               0x1787, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PERIODICAURALOG,                    0x051B, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_NAME_QUERY_RESPONSE,            0x1F08, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PLAYED_TIME,                        0x1C69, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_PLAYERBINDERROR,                    0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_PLAYERBOUND,                        0x00E8, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_DIFFICULTY_CHANGE,           0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_PLAYER_MOVE,                        0x1CB2, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PONG,                               0x15B1, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_POWER_UPDATE,                       0x1441, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUERY_TIME_RESPONSE,                0x0E2A, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_OFFER_REWARD,            0x0F77, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_COMPLETE,          0x0D54, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_DETAILS,           0x0966, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_LIST,              0x0733, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_REQUEST_ITEMS,           0x0A32, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_STATUS,                  0x0D7E, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_STATUS_MULTIPLE,         0x0F79, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_QUESTLOG_FULL,                      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_KILL,               0x0000, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUEST_QUERY_RESPONSE,               0x0F13, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RAID_READY_CHECK,                   0x072A, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_RAID_READY_CHECK_CONFIRM,           0x1641, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RANDOM_ROLL,                        0x0529, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_RANDOMIZE_CHAR_NAME,                0x074B, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_REALM_SPLIT,                        0x145A, STATUS_UNHANDLED); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_REFORGE_RESULT,                     0x1601, STATUS_NEVER	   );
    DEFINE_OPCODE_HANDLER(SMSG_REMOVED_SPELL,                      0x05E3, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_PROFICIENCY,                    0x1E3B, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_SET_TIMEZONE_INFORMATION,           0x0C2B, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SHOW_BANK,                          0x060B, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELLHEALLOG,                       0x1BBF, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELLLOGEXECUTE,                    0x19B4, STATUS_UNHANDLED); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_SPELLLOGMISS,                       0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPELLNONMELEEDAMAGELOG,             0x0172, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_CATEGORY_COOLDOWN,            0x053B, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_COOLDOWN,                     0x1B14, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_DELAYED,                      0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_FAILED_OTHER,                 0x1E7A, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_FAILURE,                      0x0E03, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_GO,                           0x0851, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_SPELL_START,                        0x0130, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TALENTS_INFO,                       0x0C68, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TEXT_EMOTE,                         0x0522, STATUS_UNHANDLED); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TIME_SYNC_REQ,                      0x12F1, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TRAINER_LIST,                       0x1509, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_TRANSFER_ABORTED,                   0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_TRANSFER_PENDING,                   0x0440, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_TRIGGER_CINEMATIC,                  0x04CC, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_TUTORIAL_FLAGS,                     0x10A7, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_COMBO_POINTS,                0x0C88, STATUS_NEVER); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_UPDATE_OBJECT,                      0x1725, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_WARDEN_DATA,                        0x14EB, STATUS_UNHANDLED); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_WHO,                                0x0460, STATUS_NEVER    ); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(SMSG_WHOIS,                              0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_WORLD_SERVER_INFO,                  0x0000, STATUS_NEVER    );
    DEFINE_OPCODE_HANDLER(SMSG_WORLD_STATE_UI_TIMER_UPDATE,        0x0C22, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(MSG_VERIFY_CONNECTIVITY,                 0x4F57, STATUS_UNHANDLED); // 5.4.7 18019
    DEFINE_OPCODE_HANDLER(MSG_MOVE_TELEPORT,                       0x00D5, STATUS_NEVER    ); // 5.4.7 18019
