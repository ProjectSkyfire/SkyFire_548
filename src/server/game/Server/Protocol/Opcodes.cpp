...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_LEAVE,                  0x045F, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::HandleBattlefieldLeaveOpcode       );
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_LIST,                   0x1412, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleBattlefieldListOpcode        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BATTLEMASTER_JOIN,                  0x06DD, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleBattlemasterJoinOpcode       );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_BUYBACK_ITEM,                       0x07D7, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleBuybackItem                  ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CLEAR_RAID_MARKER,                  0x14E9, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL                        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_EMOTE,                              0x037D, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleEmoteOpcode                  );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LFG_JOIN,                           0x18B8, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgJoinOpcode                );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LF_GUILD_BROWSE,                    0x0992, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderBrowse            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_LF_GUILD_POST_REQUEST,              0x1DAA, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderPostRequest       );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_PARTY,                  0x0F02, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode            ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(CMSG_OPEN_ITEM,                          0x146C, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleOpenItemOpcode               );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_QUESTLOG_REMOVE_QUEST,              0x0655, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleQuestLogRemoveQuest          );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_REFORGE_ITEM,                       0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::HandleReforgeItemOpcode            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_CONTACT_NOTES,                  0x03A4, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetContactNotesOpcode        );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_FACTION_ATWAR,                  0x03F6, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetFactionAtWar              );
    DEFINE_OPCODE_HANDLER(CMSG_SET_FACTION_INACTIVE,               0x057C, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetFactionInactiveOpcode     );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SPLIT_ITEM,                         0x140A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSplitItemOpcode              );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SWAP_INV_ITEM,                      0x1403, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSwapInvItemOpcode            );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_TOGGLE_LOOT_SPECIALIZATION,		   0x0176, STATUS_UNHANDLED, PROCESS_INPLACE, 	   &WorldSession::Handle_NULL                 	     ); // 5.4.7 18019
	DEFINE_OPCODE_HANDLER(CMSG_TOGGLE_PVP,                         0x16BA, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleTogglePvP                    );
    ...
    DEFINE_OPCODE_HANDLER(MSG_SET_DUNGEON_DIFFICULTY,              0x1898, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetDungeonDifficultyOpcode   );
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_LIST,                   0x1408, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_ENTRY_INVITE,       0x147A, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE, 0x1E40, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_STATUS_QUEUED,          0x15E8, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_EMOTE,                              0x0522, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LFG_QUEUE_STATUS,                   0x1661, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_BROWSE_UPDATED,            0x1852, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_COMMAND_RESULT,            0x0000, STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_MEMBERSHIP_LIST_UPDATED,   0x181B, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_RAID_MARKERS_CHANGED,               0x14E0, STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_REAL_GROUP_UPDATE,                  0x0e61, STATUS_UNHANDLED); // 5.4.7 not sure
    ...
    DEFINE_OPCODE_HANDLER(SMSG_REFORGE_RESULT,                     0x0000, STATUS_UNHANDLED);
