...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_EXPLORATION_EXPERIENCE,             0x13A1, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_KILL,               0x0B1A, STATUS_NEVER    ); // 5.4.7 18019
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SET_FACTION_STANDING,               0x0E6B, STATUS_NEVER    ); // 5.4.7 18019
