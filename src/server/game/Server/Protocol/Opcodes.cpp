...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_CONTENTS,                      0x121F, STATUS_UNHANDLED); // 5.4.8 18414 not implemented
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ITEM_NOTIFY,                   0x080F, STATUS_UNHANDLED); // 5.4.8 18414 not implemented
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MAP_OBJ_EVENTS,                     0x00BB, STATUS_UNHANDLED); // 5.4.8 18414 not implemented
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MESSAGE_BOX,                        0x02AE, STATUS_UNHANDLED); // 5.4.8 18414 not implemented
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MISSILE_CANCEL,                     0x1203, STATUS_UNHANDLED); // 5.4.8 18414 not implemented
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_COLLISION_DISABLE,             0x15B8, STATUS_UNHANDLED); // 5.4.8 18414 not implemented
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_COLLISION_ENABLE,              0x1826, STATUS_UNHANDLED); // 5.4.8 18414 not implemented
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_FEATHER_FALL,                  0x0C60, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_GRAVITY_DISABLE,               0x159F, STATUS_NEVER    ); // 5.4.8 18414 not implemented
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_GRAVITY_ENABLE,                0x0A27, STATUS_NEVER    ); // 5.4.8 18414 not implemented
    ...
    DEFINE_OPCODE_HANDLER(SMSG_THREAT_REMOVE,                      0x1E0F, STATUS_UNHANDLED);
