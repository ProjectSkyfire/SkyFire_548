...
#define DEFINE_OPCODE_HANDLER(opcode, status) ValidateAndSetOpcode<(opcode < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CORPSE_NOT_IN_INSTANCE,                  STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_CORPSE_RECLAIM_DELAY,                    STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_DEATH_RELEASE_LOC,                       STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PERIODICAURALOG,                         STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELLHEALLOG,                            STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPELLLOGEXECUTE,                         STATUS_NEVER    );
