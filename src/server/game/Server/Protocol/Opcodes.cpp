...
#define DEFINE_OPCODE_HANDLER(opcode, status) ValidateAndSetOpcode<(opcode < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_BUY_ITEM,                                STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_CANCEL_COMBAT,                           STATUS_NEVER    );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_DECLINE,                           STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_DESTROYED,                         STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_INVITE,                            STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_LIST,                              STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_GROUP_SET_LEADER,                        STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ITEM_PUSH_RESULT,                        STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_CLEAR_MONEY,                        STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_MONEY_NOTIFY,                       STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_RELEASE_RESPONSE,                   STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_REMOVED,                            STATUS_UNHANDLED);
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_RESPONSE,                           STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MONEY_NOTIFY,                            STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PARTY_COMMAND_RESULT,                    STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_REMOVED_SPELL,                           STATUS_UNHANDLED);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_WHO,                                     STATUS_UNHANDLED);
