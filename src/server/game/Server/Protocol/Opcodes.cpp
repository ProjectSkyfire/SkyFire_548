...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_CAN_TRANSITION_BETWEEN_SWIM_AND_FLY_ACK, 0x11DB, STATUS_LOGGEDIN,            PROCESS_THREADSAFE,   &WorldSession::HandleMoveSetCanTransitionBetweenSwimAndFlyAck); // 5.4.8 18414
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_ARENA_UNIT_DESTROYED,                           0x0000, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT,                                    0x0000, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ALL_PASSED,                                0x0EBB, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ROLLS_COMPLETE,                            0x101B, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_ROLL_WON,                                  0x0A3A, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_START_ROLL,                                0x0EAA, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_APPLY_MOVEMENT_FORCE,               0x0AB6, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_REMOVE_MOVEMENT_FORCE,              0x1464, STATUS_NEVER    ); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_QUERY_QUESTS_COMPLETED_RESPONSE,                0x0000, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_READ_ITEM_RESULT_FAILED,                        0x0000, STATUS_UNHANDLED); // 5.4.8 18414
    ...
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_DISABLE,                  0x15B8, STATUS_NEVER    ); // 5.4.8 18414
    DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_ENABLE,                   0x1826, STATUS_NEVER    ); // 5.4.8 18414
