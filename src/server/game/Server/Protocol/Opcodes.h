...
enum Opcodes
{
   ...
   CMSG_CHAR_CREATE                                         = 0x09B9, // 5.4.7 17930
   CMSG_CHAR_CUSTOMIZE                                      = 0x0,
   CMSG_CHAR_DELETE                                         = 0x113B, // 5.4.7 17930
   CMSG_CHAR_ENUM                                           = 0x12C2, // 5.4.7 17930
   ...
   CMSG_LEARN_TALENT                                        = 0x1F5A, // 5.4.7 17930
   ...
   CMSG_MESSAGECHAT_GUILD                                   = 0x070B, // 5.4.7 17930
   CMSG_MESSAGECHAT_OFFICER                                 = 0x0,
   CMSG_MESSAGECHAT_PARTY                                   = 0x0,
   CMSG_MESSAGECHAT_RAID                                    = 0x0,
   CMSG_MESSAGECHAT_RAID_WARNING                            = 0x0,
   CMSG_MESSAGECHAT_SAY                                     = 0x0C41, // 5.4.7 17930
   CMSG_MESSAGECHAT_WHISPER                                 = 0x0D60, // 5.4.7 17930
   CMSG_MESSAGECHAT_YELL                                    = 0x0C43, // 5.4.7 17930
   ...
   CMSG_TIME_SYNC_RESP                                      = 0x0413, // 5.4.7 17930
   ...
   CMSG_TUTORIAL_FLAG                                       = 0x07A4, // 5.4.7 17930
   ...
   CMSG_USE_ITEM                                            = 0x0,
   CMSG_VIOLENCE_LEVEL                                      = 0x05A0, // 5.4.7 17930
   ...
   CMSG_WARDEN_DATA                                         = 0x1681, // 5.4.7 17930
   ...
   MSG_MOVE_FALL_LAND                                       = 0x055B, // 5.4.7 17930
   MSG_MOVE_HEARTBEAT                                       = 0x017B, // 5.4.7 17930
   MSG_MOVE_JUMP                                            = 0x0438, // 5.4.7 17930
   MSG_MOVE_SET_ALL_SPEED_CHEAT                             = 0x0,
   MSG_MOVE_SET_COLLISION_HEIGHT                            = 0x0,
   MSG_MOVE_SET_FACING                                      = 0x005A, // 5.4.7 17930
   MSG_MOVE_SET_FLIGHT_SPEED_CHEAT                          = 0x0,
   MSG_MOVE_SET_PITCH                                       = 0x047A, // 5.4.7 17930
   MSG_MOVE_SET_RAW_POSITION_ACK                            = 0x0,
   MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT                        = 0x0,
   MSG_MOVE_SET_RUN_MODE                                    = 0x0878, // 5.4.7 17930
   ...
   MSG_MOVE_SET_WALK_MODE                                   = 0x0138, // 5.4.7 17930
   MSG_MOVE_SET_WALK_SPEED_CHEAT                            = 0x0,
   MSG_MOVE_START_ASCEND                                    = 0x0430, // 5.4.7 17930
   ...
   MSG_MOVE_START_TURN_LEFT                                 = 0x011B, // 5.4.7 17930
   ...
   SMSG_ACCOUNT_DATA_TIMES                                  = 0x0F40, // 5.4.7 17930
   ...
   SMSG_AUTH_CHALLENGE                                      = 0x14B8, // 5.4.7 17930
   SMSG_AUTH_RESPONSE                                       = 0x15A0, // 5.4.7 17930
   ...
   SMSG_CHAR_CREATE                                         = 0x1469, // 5.4.7 17930
   SMSG_CHAR_CUSTOMIZE                                      = 0x0,
   SMSG_CHAR_DELETE                                         = 0x1529, // 5.4.7 17930
   SMSG_CHAR_ENUM                                           = 0x040A, // 5.4.7 17930
   ...
   SMSG_LEARNED_SPELL                                       = 0x0C99, // 5.4.7 17930
   ...
   SMSG_LOGOUT_CANCEL_ACK                                   = 0x0E0A, // 5.4.7 17930
   SMSG_LOGOUT_COMPLETE                                     = 0x0429, // 5.4.7 17930
   SMSG_LOGOUT_RESPONSE                                     = 0x0D2B, // 5.4.7 17930
   SMSG_LOG_XPGAIN                                          = 0x0,
   ...
   SMSG_MESSAGECHAT                                         = 0x0E60, // 5.4.7 17930
   ...
   SMSG_MOVE_SET_CAN_FLY                                    = 0x01F4, // 5.4.7 17930
   ...
   SMSG_PLAYER_MOVE                                         = 0x1CB2, // 5.4.7 17930
   ...
   SMSG_REALM_NAME_QUERY_RESPONSE                           = 0x1652, // 5.4.7 17930
   ...
   SMSG_SET_PROFICIENCY                                     = 0x1E3B, // 5.4.7 17930
   ...
   SMSG_TALENTS_INFO                                        = 0x0C68, // 5.4.7 17930
   ...
   SMSG_TIME_SYNC_REQ                                       = 0x12F1, // 5.4.7 17930
   ...
   SMSG_TUTORIAL_FLAGS                                      = 0x10A7, // 5.4.7 17930
   ...
   SMSG_UPDATE_OBJECT                                       = 0x1725, // 5.4.7 17930
   ...
   SMSG_WARDEN_DATA                                         = 0x14EB, // 5.4.7 17930
