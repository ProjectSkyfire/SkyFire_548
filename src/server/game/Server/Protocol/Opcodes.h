...
enum Opcodes
{
    ...
    CMSG_ADD_FRIEND                                          = 0x1388,
    CMSG_ADD_IGNORE                                          = 0x1A01,
    ...
    CMSG_ATTACKSWING                                         = 0x0855, // 5.4.2 17688 maybe 0x0854
    ...
    CMSG_SET_PRIMARY_TALENT_TREE                             = 0x085F,
    ...
    MSG_MOVE_START_STRAFE_RIGHT                              = 0x048A,
    MSG_MOVE_START_SWIM                                      = 0x007E,
    MSG_MOVE_START_TURN_LEFT                                 = 0x0409,
    MSG_MOVE_START_TURN_RIGHT                                = 0x04A0,
    MSG_MOVE_STOP                                            = 0x0609,
    MSG_MOVE_STOP_ASCEND                                     = 0x06AA,
    MSG_MOVE_STOP_PITCH                                      = 0x00F5,
    MSG_MOVE_STOP_STRAFE                                     = 0x027C,
    MSG_MOVE_STOP_SWIM                                       = 0x027F,
    MSG_MOVE_STOP_TURN                                       = 0x0488,
    MSG_MOVE_TELEPORT                                        = 0x0,
    MSG_MOVE_TELEPORT_ACK                                    = 0x0,
    MSG_MOVE_TELEPORT_CHEAT                                  = 0x0,
    MSG_MOVE_TIME_SKIPPED                                    = 0x0,
    MSG_MOVE_TOGGLE_COLLISION_CHEAT                          = 0x0037,
