...
enum Opcodes
{
   ...
   CMSG_AUTH_SESSION                                        = 0x1A51, // 5.4.7 17898
   ...
   MSG_MOVE_FALL_LAND                                       = 0x055B, // 5.4.7 17898
   MSG_MOVE_HEARTBEAT                                       = 0x017B, // 5.4.7 17898
   MSG_MOVE_JUMP                                            = 0x0438, // 5.4.7 17898
   MSG_MOVE_SET_ALL_SPEED_CHEAT                             = 0x0,
   MSG_MOVE_SET_COLLISION_HEIGHT                            = 0x0,
   MSG_MOVE_SET_FACING                                      = 0x005A, // 5.4.7 17898
   MSG_MOVE_SET_FLIGHT_SPEED_CHEAT                          = 0x0,
   MSG_MOVE_SET_PITCH                                       = 0x047A, // 5.4.7 17898
   MSG_MOVE_SET_RAW_POSITION_ACK                            = 0x0,
   MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT                        = 0x0,
   MSG_MOVE_SET_RUN_MODE                                    = 0x0878, // 5.4.7 17898
   ...
   MSG_MOVE_SET_WALK_MODE                                   = 0x0138, // 5.4.7 17898
   MSG_MOVE_SET_WALK_SPEED_CHEAT                            = 0x0,
   MSG_MOVE_START_ASCEND                                    = 0x0430, // 5.4.7 17898
   MSG_MOVE_START_BACKWARD                                  = 0x0459, // 5.4.7 17898
   MSG_MOVE_START_DESCEND                                   = 0x0132, // 5.4.7 17898
   MSG_MOVE_START_FORWARD                                   = 0x041B, // 5.4.7 17898
   MSG_MOVE_START_PITCH_DOWN                                = 0x0,
   MSG_MOVE_START_PITCH_UP                                  = 0x0,
   MSG_MOVE_START_STRAFE_LEFT                               = 0x0873, // 5.4.7 17898
   MSG_MOVE_START_STRAFE_RIGHT                              = 0x0C12, // 5.4.7 17898
   MSG_MOVE_START_SWIM                                      = 0x0871, // 5.4.7 17898
   MSG_MOVE_START_TURN_LEFT                                 = 0x011B, // 5.4.7 17898
   MSG_MOVE_START_TURN_RIGHT                                = 0x0411, // 5.4.7 17898
   MSG_MOVE_STOP                                            = 0x0570, // 5.4.7 17898
   MSG_MOVE_STOP_ASCEND                                     = 0x0012, // 5.4.7 17898
   MSG_MOVE_STOP_PITCH                                      = 0x0,
   MSG_MOVE_STOP_STRAFE                                     = 0x0171, // 5.4.7 17898
   MSG_MOVE_STOP_SWIM                                       = 0x0578, // 5.4.7 17898
   MSG_MOVE_STOP_TURN                                       = 0x0530, // 5.4.7 17898
   ...
   SMSG_ACCOUNT_DATA_TIMES                                  = 0x0F40, // 5.4.7 17898
   ...
   SMSG_AUTH_CHALLENGE                                      = 0x14B8, // 5.4.7 17898
   SMSG_AUTH_RESPONSE                                       = 0x15A0, // 5.4.7 17898
