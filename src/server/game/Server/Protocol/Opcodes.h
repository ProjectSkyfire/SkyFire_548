...
enum Opcodes
{
   ...
   CMSG_ATTACKSTOP                                          = 0x1E13, // 5.4.7 17956 0x1777 
   CMSG_ATTACKSWING                                         = 0x1513, // 5.4.7 17956
   ...
   CMSG_AUTH_SESSION                                        = 0x1A51, // 5.4.7 17956
   CMSG_AUTOBANK_ITEM                                       = 0x0,
   CMSG_AUTOEQUIP_GROUND_ITEM                               = 0x0,
   CMSG_AUTOEQUIP_ITEM                                      = 0x166B, // 5.4.7 17956
   ...
   CMSG_BUY_ITEM                                            = 0x1077, // 5.4.7 17956
   ...
   CMSG_CHAR_CREATE                                         = 0x09B9, // 5.4.7 17956
   CMSG_CHAR_CUSTOMIZE                                      = 0x0,
   CMSG_CHAR_DELETE                                         = 0x113B, // 5.4.7 17956
   CMSG_CHAR_ENUM                                           = 0x12C2, // 5.4.7 17956
   ...
   CMSG_CREATURE_QUERY                                      = 0x1E72, // 5.4.7 17956
   ...
   CMSG_GAMEOBJECT_QUERY                                    = 0x14EA, // 5.4.7 17956
   ...
   CMSG_GOSSIP_HELLO                                        = 0x05F6, // 5.4.7 17956
   CMSG_GOSSIP_SELECT_OPTION                                = 0x02D7, // 5.4.7 17956
   ...
   CMSG_LEARN_TALENT                                        = 0x1F5A, // 5.4.7 17956
   ...
   CMSG_LIST_INVENTORY                                      = 0x10DD, // 5.4.7 17956
   CMSG_LOAD_SCREEN                                         = 0x1691, // 5.4.7 17956
   CMSG_LOGOUT_CANCEL                                       = 0x11D4, // 5.4.7 17956
   CMSG_LOGOUT_REQUEST                                      = 0x0476, // 5.4.7 17956
   CMSG_LOG_DISCONNECT                                      = 0x1A13, // 5.4.7 17956
   CMSG_LOOT                                                = 0x0,
   ...
   CMSG_MESSAGECHAT_GUILD                                   = 0x070B, // 5.4.7 17956
   CMSG_MESSAGECHAT_OFFICER                                 = 0x0,
   CMSG_MESSAGECHAT_PARTY                                   = 0x0,
   CMSG_MESSAGECHAT_RAID                                    = 0x0,
   CMSG_MESSAGECHAT_RAID_WARNING                            = 0x0,
   CMSG_MESSAGECHAT_SAY                                     = 0x0C41, // 5.4.7 17956
   CMSG_MESSAGECHAT_WHISPER                                 = 0x0D60, // 5.4.7 17956
   CMSG_MESSAGECHAT_YELL                                    = 0x0C43, // 5.4.7 17956
   ...
   CMSG_NAME_QUERY                                          = 0x0DB3, // 5.4.7 17956
   ...
   CMSG_PING                                                = 0x1070, // 5.4.7 17956
   CMSG_PLAYED_TIME                                         = 0x0,
   CMSG_PLAYER_DIFFICULTY_CHANGE                            = 0x0,
   CMSG_PLAYER_LOGIN                                        = 0x17D3, // 5.4.7 17956
   ...
   CMSG_READY_FOR_ACCOUNT_DATA_TIMES                        = 0x13CB, // 5.4.7 17956
   CMSG_READ_ITEM                                           = 0x0,
   CMSG_REALM_SPLIT                                         = 0x0,
   CMSG_REALM_NAME_QUERY                                    = 0x1899, // 5.4.7 17956
   ...
   CMSG_SELF_RES                                            = 0x0,
   CMSG_SELL_ITEM                                           = 0x115F, // 5.4.7 17956
   CMSG_SEND_MAIL                                           = 0x0,
   ...
   CMSG_SET_PRIMARY_TALENT_TREE                             = 0x04AA, // 5.4.7 17956
   CMSG_SET_RELATIVE_POSITION                               = 0x0,
   CMSG_SET_SAVED_INSTANCE_EXTEND                           = 0x0,
   CMSG_SET_SELECTION                                       = 0x10D5, // 5.4.7 17956
   ...
   CMSG_SWAP_ITEM                                           = 0x150A, // 5.4.7 17956
   CMSG_SYNC_DANCE                                          = 0x0,
   ...
   CMSG_TIME_SYNC_RESP                                      = 0x0413, // 5.4.7 17956
   ...
   CMSG_TUTORIAL_FLAG                                       = 0x07A4, // 5.4.7 17956
   ...
   CMSG_WARDEN_DATA                                         = 0x1681, // 5.4.7 17956
   ...
   MSG_MOVE_FALL_LAND                                       = 0x055B, // 5.4.7 17956
   MSG_MOVE_HEARTBEAT                                       = 0x017B, // 5.4.7 17956
   MSG_MOVE_JUMP                                            = 0x0438, // 5.4.7 17956
   MSG_MOVE_SET_ALL_SPEED_CHEAT                             = 0x0,
   MSG_MOVE_SET_COLLISION_HEIGHT                            = 0x0,
   MSG_MOVE_SET_FACING                                      = 0x005A, // 5.4.7 17956
   MSG_MOVE_SET_FLIGHT_SPEED_CHEAT                          = 0x0,
   MSG_MOVE_SET_PITCH                                       = 0x047A, // 5.4.7 17956
   MSG_MOVE_SET_RAW_POSITION_ACK                            = 0x0,
   MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT                        = 0x0,
   MSG_MOVE_SET_RUN_MODE                                    = 0x0878, // 5.4.7 17956
   ...
   MSG_MOVE_SET_WALK_MODE                                   = 0x0138, // 5.4.7 17956
   MSG_MOVE_SET_WALK_SPEED_CHEAT                            = 0x0,
   MSG_MOVE_START_ASCEND                                    = 0x0430, // 5.4.7 17956
   MSG_MOVE_START_BACKWARD                                  = 0x0459, // 5.4.7 17956
   MSG_MOVE_START_DESCEND                                   = 0x0132, // 5.4.7 17956
   MSG_MOVE_START_FORWARD                                   = 0x041B, // 5.4.7 17956
   MSG_MOVE_START_PITCH_DOWN                                = 0x093B, // 5.4.7 17956
   MSG_MOVE_START_PITCH_UP                                  = 0x0079, // 5.4.7 17956
   MSG_MOVE_START_STRAFE_LEFT                               = 0x0873, // 5.4.7 17956
   MSG_MOVE_START_STRAFE_RIGHT                              = 0x0C12, // 5.4.7 17956
   MSG_MOVE_START_SWIM                                      = 0x0871, // 5.4.7 17956
   MSG_MOVE_START_TURN_LEFT                                 = 0x011B, // 5.4.7 17956
   MSG_MOVE_START_TURN_RIGHT                                = 0x0411, // 5.4.7 17956
   MSG_MOVE_STOP                                            = 0x0570, // 5.4.7 17956
   MSG_MOVE_STOP_ASCEND                                     = 0x0012, // 5.4.7 17956
   MSG_MOVE_STOP_PITCH                                      = 0x0071, // 5.4.7 17956
   MSG_MOVE_STOP_STRAFE                                     = 0x0171, // 5.4.7 17956
   MSG_MOVE_STOP_SWIM                                       = 0x0578, // 5.4.7 17956
   MSG_MOVE_STOP_TURN                                       = 0x0530, // 5.4.7 17956
   MSG_MOVE_TELEPORT                                        = 0x00D5, // 5.4.7 17956
   MSG_MOVE_TELEPORT_ACK                                    = 0x0978, // 5.4.7 17956
   ...
   MSG_MOVE_WORLDPORT_ACK                                   = 0x18BB, // 5.4.7 17956
   ...
   MSG_VERIFY_CONNECTIVITY                                  = 0x4F57, // Constant Opcode - Never changes
   SMSG_ACCOUNT_DATA_TIMES                                  = 0x0F40, // 5.4.7 17956
   SMSG_ACCOUNT_INFO_RESPONSE                               = 0x0,
   SMSG_ACCOUNT_RESTRICTED_WARNING                          = 0x0,
   SMSG_ACHIEVEMENT_DELETED                                 = 0x0,
   SMSG_ACHIEVEMENT_EARNED                                  = 0x0,
   SMSG_ACTION_BUTTONS                                      = 0x1768, // 5.4.7 17956
   SMSG_ACTIVATETAXIREPLY                                   = 0x0,
   SMSG_ADDON_INFO                                          = 0x10E2, // 5.4.7 17956
   ...
   SMSG_ATTACKERSTATEUPDATE                                 = 0x0540, // 5.4.7 17956
   SMSG_ATTACKSTART                                         = 0x0403, // 5.4.7 17956
   SMSG_ATTACKSTOP                                          = 0x1448, // 5.4.7 17956
   ...
   SMSG_CHAR_CREATE                                         = 0x1469, // 5.4.7 17956
   SMSG_CHAR_CUSTOMIZE                                      = 0x0,
   SMSG_CHAR_DELETE                                         = 0x1529, // 5.4.7 17956
   SMSG_CHAR_ENUM                                           = 0x040A, // 5.4.7 17956
   ...
   SMSG_CLIENTCACHE_VERSION                                 = 0x1E41, // 5.4.7 17956
   ...
   SMSG_CREATURE_QUERY_RESPONSE                             = 0x00E0, // 5.4.7 17956
   ...
   SMSG_GAMEOBJECT_QUERY_RESPONSE                           = 0x066A, // 5.4.7 17956
   ...
   SMSG_INITIAL_SPELLS                                      = 0x1B05, // 5.4.7 17956
   ...
   SMSG_LIST_INVENTORY                                      = 0x0D2A, // 5.4.7 17956
   SMSG_LOAD_CUF_PROFILES                                   = 0x0,
   SMSG_LOGIN_SETTIMESPEED                                  = 0x0F4A, // 5.4.7 17956
   SMSG_LOGIN_VERIFY_WORLD                                  = 0x0603, // 5.4.7 17956
   SMSG_LOGOUT_CANCEL_ACK                                   = 0x0E0A, // 5.4.7 17956
   SMSG_LOGOUT_COMPLETE                                     = 0x0429, // 5.4.7 17956
   SMSG_LOGOUT_RESPONSE                                     = 0x0D2B, // 5.4.7 17956
   SMSG_LOG_XPGAIN                                          = 0x1613, // 5.4.7 17956
   ...
   SMSG_MESSAGECHAT                                         = 0x0E60, // 5.4.7 17956
   ...
   SMSG_MONSTER_MOVE                                        = 0x12D8, // 5.4.7 17956
   SMSG_MONSTER_MOVE_TRANSPORT                              = 0x0, // Obsolute
   SMSG_MOTD                                                = 0x0E20, // 5.4.7 17956
   ...
   SMSG_MOVE_SET_CAN_FLY                                    = 0x01F4, // 5.4.7 17956
   ...
   SMSG_NAME_QUERY_RESPONSE                                 = 0x1E5B, // 5.4.7 17956
   SMSG_NEW_TAXI_PATH                                       = 0x0,
   SMSG_NEW_WORLD                                           = 0x05AB, // 5.4.7 17956
   ...
   SMSG_PLAYER_MOVE                                         = 0x1CB2, // 5.4.7 17956
   ...
   SMSG_REALM_NAME_QUERY_RESPONSE                           = 0x1652, // 5.4.7 17956
   ...
   SMSG_SPELLHEALLOG                                        = 0x1BBF, // 5.4.7 17956
   ...
   SMSG_TALENTS_INFO                                        = 0x0C68, // 5.4.7 17956
   ...
   SMSG_TIME_SYNC_REQ                                       = 0x12F1, // 5.4.7 17956
   ...
   SMSG_TUTORIAL_FLAGS                                      = 0x10A7, // 5.4.7 17956
   ...
   SMSG_UPDATE_OBJECT                                       = 0x1725, // 5.4.7 17956
   ...
   SMSG_WARDEN_DATA                                         = 0x14EB, // 5.4.7 17956
