...
namespace SkyFire::Impl::StringConvertImpl
{
    template <typename T, typename = void> struct For
    {
        static_assert(SkyFire::dependant_false_v<T>, "Unsupported type used for ToString or StringTo");
    };
...
#ifdef NEED_CHARCONV_WORKAROUND
    /*
...
namespace SkyFire
{
    ...
    {
        return SkyFire::Impl::StringConvertImpl::For<Result>::FromString(str, std::forward<Params>(params)...);
    }

    template <typename Type, typename... Params>
    std::string ToString(Type&& val, Params&&... params)
    {
        return SkyFire::Impl::StringConvertImpl::For<std::decay_t<Type>>::ToString(std::forward<Type>(val), std::forward<Params>(params)...);
    }
}
