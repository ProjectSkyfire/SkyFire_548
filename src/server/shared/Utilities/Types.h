...
namespace SkyFire
{
    ...
    /*
        ...
        struct Example
        {
            using TupleArg = SkyFire::find_type_if_t<SkyFire::is_tuple, Ts...>;

            bool HasTuple()
            {
                return !std::is_same_v<TupleArg, SkyFire::find_type_end>;
            }
        };
        ...
        example2.HasTuple() == false; // TupleArg is SkyFire::find_type_end
    */
