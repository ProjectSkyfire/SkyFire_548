...
/*static*/ std::string SkyFire::Encoding::Base64::Encode(std::vector<uint8> const& data)
{
    return SkyFire::Impl::GenericBaseEncoding<B64Impl>::Encode(data);
}

/*static*/ Optional<std::vector<uint8>> SkyFire::Encoding::Base64::Decode(std::string const& data)
{
    return SkyFire::Impl::GenericBaseEncoding<B64Impl>::Decode(data);
}
