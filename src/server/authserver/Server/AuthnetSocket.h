...
private:
    ...
    std::string _authnetIdentity;
    std::string _authnetPlatform;
    std::string _authnetLocale;
    ...
    std::unique_ptr<SkyFire::Crypto::AuthnetSRP6> _authnetSrp;
    std::unique_ptr<SkyFire::Crypto::AuthnetPasswordProof> _authnetPasswordProof;
    ...
    bool _authnetAuthenticationPending;
    bool _authnetRiskFingerprintPending;
