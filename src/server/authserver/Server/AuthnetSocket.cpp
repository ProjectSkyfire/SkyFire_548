...
namespace
{
    bool IsAuthnetVerboseLoggingEnabled()
    {
        return sConfigMgr->GetBoolDefault("Authnet.VerboseLogging", false);
    }

#define AUTHNET_LOG_VERBOSE(...)                                      \
    do                                                                \
    {                                                                 \
        if (IsAuthnetVerboseLoggingEnabled())                         \
            SF_LOG_INFO("server.authserver", __VA_ARGS__);           \
    } while (0)
    ...
    constexpr uint8 AuthnetPasswordChallengeState = 0;
    constexpr uint8 AuthnetServerEncryptionSeed[] =
    {
        0x68, 0xE0, 0xC7, 0x2E, 0xDD, 0xD6, 0xD2, 0xF3,
        0x1E, 0x5A, 0xB1, 0x55, 0xB1, 0x8B, 0x63, 0x1E
    };
    constexpr uint8 AuthnetClientDecryptionSeed[] =
    {
        0xDE, 0xA9, 0x65, 0xAE, 0x54, 0x3A, 0x1E, 0x93,
        0x9E, 0x69, 0x0C, 0xAA, 0x68, 0xDE, 0x78, 0x39
    };
    constexpr uint8 AuthnetThumbprintModuleKey[] =
    {
        0x61, 0x75, 0x74, 0x68, 0x00, 0x00, 0x45, 0x55,
        0xC3, 0xA1, 0xAC, 0x06, 0x94, 0x97, 0x9E, 0x70, 0x9C, 0x3B, 0x54, 0x86, 0x92, 0x7E, 0x55, 0x8A,
        0xF1, 0xE2, 0xBE, 0x02, 0xCA, 0x96, 0xE5, 0x61, 0x5C, 0x5A, 0x65, 0xAA, 0xCC, 0x82, 0x92, 0x26
    };
    constexpr uint8 AuthnetRiskFingerprintModuleKey[] =
    {
        0x61, 0x75, 0x74, 0x68, 0x00, 0x00, 0x45, 0x55,
        0x8C, 0x43, 0xBD, 0xA1, 0x0B, 0xE3, 0x3A, 0x32, 0xAB, 0xBC, 0x09, 0xFB, 0x22, 0x79, 0x12, 0x6C,
        0x7F, 0x59, 0x53, 0x33, 0x63, 0x91, 0x27, 0x6C, 0xFF, 0x58, 0x85, 0x65, 0x33, 0x2F, 0xCD, 0x40
    };
    char constexpr AuthnetThumbprintModuleDataHex[] =
        "E716F4F0A01EB9C032A6C1393356A4F766F067949D71023C0CFC0613718966EF814E65CC6EE70C432A7F8AFD8A062B52603A2697E851D231D72C0277614181D7"
        "13369B1E8E4BEEAB72045A9AAD45F319DB918ECDDB83C8EF8B7510600D391D45E7FEC0BEEAE904A5F9FA620F1CCDAD699D84A4739CE669B5A551831E396214E13"
        "B4C88F573F5CDC784CD01530C086B674C03BEB66403A0F87ED17ABBB403DE54CF31BE828A20C566C22E4D4263AA77220B0644D99245345BCAC276EA06925EB984D"
        "664725C3CB757140AFE12E27CB996F17159B1057E9B58B78BBB5A139C9FF6215A0D250B75FC9DD435655DDEADCD6CFD84800792C146B3633188ECEB53D2038C185"
        "E0BD51A9E6C70FD38ADF530F8DF50FB62053C5E894897AB7DD65C7AC80665F18E7989BE6E30F15E939751123D6D8A44F033175301D15AAAD2AEA06FAC60BA40658"
        "46AE938F32B1CB15F16DC0E76792A7332346896048065D17C059899E1D2300E402BD0EA74265DA6A42B1C854E2470D7B21AE4A2DAE90E602A759B2CA0EE610B50D"
        "5389DB89335D5451FE76DD85B09FD5297D6F9EFB6C34CE885007F7DF20D6A524E0C3E772FA04B3DD2E014D3A337A790943DAD523CBB5453F4FDF8E74DFE361BD5"
        "F25AB31952B478148B570DF5762643F32B994FEC99A747E4A265A66EE84A53509EC285C84679606049314FC526C61B537AC8061C788F8B86F52208";
    ...
    char const* AuthnetPacketName(uint32 mode, uint32 command, uint32 modeSwitch)
    {
        ...
        switch (mode)
        {
            ...
            case 1:
                ...
                {
                    case 0:
                        return "ConnectionPingOrPong";
                    case 1:
                        return "ConnectionBoom";
                    case 2:
                        return "ConnectionRegulatorUpdate";
                    case 3:
                        return "ConnectionServerVersion";
                    case 4:
                        return "ConnectionStunServers";
                    case 5:
                        return "ConnectionEnableEncryption";
                    case 6:
                        return "ConnectionLogoutRequest";
                    case 7:
                        return "ConnectionDisconnectRequest";
                    case 9:
            ...
            case 2:
                ...
                {
                    case 0:
                        return "RealmListSubscribe";
                    case 1:
                        return "RealmListUnsubscribe";
                    case 2:
                        return "RealmListUpdate";
                    case 3:
                        return "RealmListComplete";
                    case 6:
                        return "RealmToonReady";
                    case 7:
                        return "RealmToonLoggedOut";
                    case 8:
                        return "RealmJoin";
                    case 9:
                        return "RealmMultiLogon";
                    default:
                        return "RealmUnknown";
                }
            case 11:
                ...
                {
                    case 2:
                        return "CacheGatewayLookupRequest";
                    case 3:
                        return "CacheGatewayLookupResponse";
                    case 4:
                        return "CacheConnect";
                    case 7:
                        return "CacheDataOrPublishList";
                    case 8:
                        return "CacheResult";
                    case 9:
                        return "CacheStreamItems";
                    default:
                        return "CacheUnknown";
                }
            default:
    ...
    std::vector<uint8> BuildNativePasswordChallenge(
        SkyFire::Crypto::AuthnetSRP6 const& srp, SkyFire::Crypto::AuthnetPasswordProof const& passwordProof)
    {
        auto const& identityHash = srp.GetIdentityHash();
        auto const& salt = srp.GetSalt();
        auto const& publicValue = srp.GetServerPublicValue();
        auto const& serverChallenge = passwordProof.GetChallenge();

        std::vector<uint8> challenge;
        challenge.reserve(1 + identityHash.size() + salt.size() + publicValue.size() + serverChallenge.size());
        challenge.push_back(AuthnetPasswordChallengeState);
        challenge.insert(challenge.end(), identityHash.begin(), identityHash.end());
        challenge.insert(challenge.end(), salt.begin(), salt.end());
        challenge.insert(challenge.end(), publicValue.begin(), publicValue.end());
        challenge.insert(challenge.end(), serverChallenge.begin(), serverChallenge.end());
        return challenge;
    }
    ...
    std::string GetAuthnetPasswordProofPrivateKey()
    {
        if (HasEnvValue("AUTHNET_PASSWORD_PROOF_PRIVATE_KEY"))
            return std::getenv("AUTHNET_PASSWORD_PROOF_PRIVATE_KEY");

        return sConfigMgr->GetStringDefault("Authnet.PasswordProofPrivateKey", "");
    }
    ...
    std::vector<uint8> BuildNativePasswordProofRequest(
        std::vector<uint8> const& generatedStartupModuleKey,
        std::vector<uint8> const& passwordChallenge,
        std::vector<uint8>* startupModuleKey,
        char const** startupModuleKeySource)
    {
        Skyfire::Authnet::BitWriter writer;
        char const* moduleKeySource = nullptr;
        std::vector<uint8> moduleKey = BuildStartupModuleKey(generatedStartupModuleKey, &moduleKeySource);
        std::vector<uint8> thumbprintData;

        if (!TryParseHexBytes(AuthnetThumbprintModuleDataHex, 512, thumbprintData))
            return {};

        if (startupModuleKey)
            *startupModuleKey = moduleKey;
        if (startupModuleKeySource)
            *startupModuleKeySource = moduleKeySource;
        ...
        writer.WriteBits(uint32(passwordChallenge.size()), 10);
        writer.WriteBytes(passwordChallenge.data(), passwordChallenge.size());
        writer.WriteBytes(AuthnetThumbprintModuleKey, sizeof(AuthnetThumbprintModuleKey));
        writer.WriteBits(uint32(thumbprintData.size()), 10);
        writer.WriteBytes(thumbprintData.data(), thumbprintData.size());

        return writer.Data();
    }

    std::vector<uint8> BuildNativePasswordAcceptedProofRequest(
        std::vector<uint8> const& moduleKey,
        SkyFire::Crypto::AuthnetSRP6::Proof const& sessionVerifier,
        SkyFire::Crypto::AuthnetPasswordProof::Value const& serverSignature)
    {
        std::vector<uint8> passwordResult;
        passwordResult.reserve(1 + sessionVerifier.size() + serverSignature.size());
        passwordResult.push_back(3);
        passwordResult.insert(passwordResult.end(), sessionVerifier.begin(), sessionVerifier.end());
        passwordResult.insert(passwordResult.end(), serverSignature.begin(), serverSignature.end());
        ...
        writer.WriteBits(2, 3);
        writer.WriteBytes(moduleKey.data(), moduleKey.size());
        writer.WriteBits(uint32(passwordResult.size()), 10);
        writer.WriteBytes(passwordResult.data(), passwordResult.size());
        writer.WriteBytes(AuthnetRiskFingerprintModuleKey, sizeof(AuthnetRiskFingerprintModuleKey));
        writer.WriteBits(0, 10);
        return writer.Data();
    }

    std::vector<uint8> BuildNativeLogonSuccess(uint32 accountId, std::string const& gameAccountName)
    {
        Skyfire::Authnet::BitWriter writer;
        ...
        writer.WriteBits(uint32(120000 + std::numeric_limits<int32>::min()), 32);
        writer.WriteBits(1, 1);
        writer.WriteBits(1, 1);
        writer.WriteBits(25000000, 32);
        writer.WriteBits(1000, 32);
        writer.WriteBits(0, 8);
        writer.AlignToByte();
        writer.WriteBits(0, 8);
        writer.AlignToByte();
        writer.WriteBits(accountId, 32);
        writer.WriteBits(2, 8);
        WriteUInt64(writer, 0);
        writer.WriteBits(2, 8);

        std::string const accountName = gameAccountName.empty() ? "A" : gameAccountName;
        writer.WriteBits(uint32(accountName.size() - 1), 5);
        writer.WriteBytes(accountName.data(), accountName.size());
        WriteUInt64(writer, 0x00800000);
    ...
    uint32 ResolveAuthnetSelectedRealmField(uint32 accountId, std::vector<AuthnetRealmRoute> const& routes)
    {
        ...
        if (PreparedQueryResult result = LoginDatabase.Query(stmt))
        {
            ...
            AUTHNET_LOG_VERBOSE("authnet probe: account %u saved selected_realm_id=%u is not in the active realm list; using configured default realm_field=%u.",
    ...
    void InitializeStreamCipher(uint8 state[256], SkyFire::Crypto::HMAC_SHA256::Digest const& key)
    {
        ...
        for (uint32 i = 0; i < 256; ++i)
        {
            j = uint8(j + state[i] + key[i % key.size()]);
    ...
    bool TryDecodeNativeProofResponse(uint8 const* data, size_t length, NativeProofResponse& response)
    {
        ...
        ProbePacketHeader header;
        if (!reader.ReadBits(6, header.command) || !reader.ReadBits(1, header.modeSwitch) ||
            !header.modeSwitch || !reader.ReadBits(4, header.mode) || header.command != 2 || header.mode != 0)
            return false;

        uint32 moduleCount = 0;
        if (!reader.ReadBits(3, moduleCount) || moduleCount == 0 || moduleCount > 7)
            return false;

        response.modules.clear();
        response.modules.reserve(moduleCount);
        for (uint32 i = 0; i < moduleCount; ++i)
        {
            uint32 moduleSize = 0;
            if (!reader.ReadBits(10, moduleSize))
                return false;

            std::vector<uint8> module(moduleSize);
            if (!reader.ReadBytes(module.data(), module.size()))
                return false;

            response.modules.push_back(std::move(module));
        }

        response.packetLength = (reader.BitPosition() + 7) / 8;
        return true;
    }
...
AuthnetSocket::AuthnetSocket(RealmSocket& socket) :
    ...
    _authnetWorldSessionKey(), _authnetStartupModuleKey(), _authnetSecret(), _authnetSrp(), _authnetPasswordProof(),
    _authnetWorldSessionKeyGenerated(false),
    _authnetWorldSessionKeyPersisted(false), _authnetStartupModuleKeyGenerated(false), _authnetLoginGrantAccepted(false),
    _authnetAuthenticationPending(false), _authnetRiskFingerprintPending(false),
...
{
    AUTHNET_LOG_VERBOSE("'%s:%d' authnet passive probe: connection accepted",
        socket().getRemoteAddress().c_str(), socket().getRemotePort());
}

void AuthnetSocket::OnClose(void)
{
    AUTHNET_LOG_VERBOSE("'%s:%d' authnet passive probe: connection closed, %zu byte(s) captured total, responded=%s",
...
void AuthnetSocket::OnRead(void)
{
    ...
    AUTHNET_LOG_VERBOSE("'%s:%d' authnet passive probe: %zu new byte(s), %zu total so far, new=%s",
...
bool AuthnetSocket::DecodeInitialRequest(void)
{
    ...
    {
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet decode: component[%u] = %s.%s.%u",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            uint32(i), request.components[i].program.c_str(), request.components[i].platform.c_str(),
            request.components[i].build);
    }

    AUTHNET_LOG_VERBOSE("'%s:%d' authnet decode: has_identity=%s identity_len=%u identity=%s tail_value=" UI64FMTD " initial_request_len=%zu initial_bits=%zu",
        socket().getRemoteAddress().c_str(), socket().getRemotePort(),
    ...
    _authnetIdentity = request.identity;
    _authnetPlatform = request.platform;
    _authnetLocale = request.locale;
    _authnetAccountId = accountId;
    _authnetAccountName = accountName;
    _authnetWorldAccountToken = BuildWorldAccountToken(accountId);
    _authnetLocaleId = GetLocaleByName(request.locale);
    ...
    {
        SF_LOG_ERROR("server.authserver", "'%s:%d' authnet authentication: native password login requires an email identity.",
            socket().getRemoteAddress().c_str(), socket().getRemotePort());
        socket().Close();
        _responded = true;
        return true;
    ...
    PreparedStatement* verifierStmt = LoginDatabase.GetPreparedStatement(LOGIN_SEL_AUTHNET_PASSWORD_VERIFIER);
    verifierStmt->setUInt32(0, accountId);
    verifierStmt->setString(1, loginIdentity.Canonical);
    PreparedQueryResult verifierResult = LoginDatabase.Query(verifierStmt);
    if (!verifierResult || (*verifierResult)[1].IsNull() || (*verifierResult)[2].IsNull())
    {
        SF_LOG_ERROR("server.authserver", "'%s:%d' authnet authentication: account %u has no native password verifier; reset its password to provision one.",
    ...
    _authnetSrp = std::make_unique<SkyFire::Crypto::AuthnetSRP6>(
        (*verifierResult)[0].GetString(),
        (*verifierResult)[1].GetBinary<SkyFire::Crypto::AuthnetSRP6::SALT_LENGTH>(),
        (*verifierResult)[2].GetBinary<SkyFire::Crypto::AuthnetSRP6::VERIFIER_LENGTH>());

    _authnetPasswordProof = std::make_unique<SkyFire::Crypto::AuthnetPasswordProof>(GetAuthnetPasswordProofPrivateKey());
    if (!_authnetPasswordProof->IsValid())
    {
        SF_LOG_ERROR("server.authserver", "'%s:%d' authnet authentication: Authnet.PasswordProofPrivateKey is missing or invalid.",
            socket().getRemoteAddress().c_str(), socket().getRemotePort());
        socket().Close();
        _responded = true;
        return true;
    ...
    _authnetAuthenticationPending = true;

    AUTHNET_LOG_VERBOSE("'%s:%d' authnet authentication: resolved account %u (%s); requesting the native client password before creating a session.",
...
bool AuthnetSocket::TryUpdateWorldSessionKeyFromSelectedRealm(std::vector<uint8> const& packet)
{
    ...
    AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: selected realm request seed=%u selected_realm_field=%u selected_realm=%s key_realm_field=%u previous_realm_field=%u source=%s.",
        socket().getRemoteAddress().c_str(), socket().getRemotePort(),
...
void AuthnetSocket::CryptClientPayload(std::vector<uint8>& payload)
{
    ...
    {
        SkyFire::Crypto::HMAC_SHA256::Digest key = SkyFire::Crypto::HMAC_SHA256::GetDigestOf(
            _authnetSecret, AuthnetClientDecryptionSeed, sizeof(AuthnetClientDecryptionSeed));
        InitializeStreamCipher(_clientCryptState, key);
        _clientCryptI = 0;
        _clientCryptJ = 0;
...
void AuthnetSocket::CryptServerPayload(std::vector<uint8>& payload)
{
    ...
    {
        SkyFire::Crypto::HMAC_SHA256::Digest key = SkyFire::Crypto::HMAC_SHA256::GetDigestOf(
            _authnetSecret, AuthnetServerEncryptionSeed, sizeof(AuthnetServerEncryptionSeed));
        InitializeStreamCipher(_serverCryptState, key);
        _serverCryptI = 0;
        _serverCryptJ = 0;
...
void AuthnetSocket::SendEncryptedRequestResult(uint32 requestId, std::vector<uint8> const* resourceKey, uint32 resourceItemId)
{
    ...
    AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted request result id=%u items=%u item_id=%u key=%s plain=%s encrypted=%s",
...
bool AuthnetSocket::TrySendMode2Command0Probe(char const* trigger, bool sendFollowups, bool forceRealmList)
{
    ...
    if (response.empty())
    {
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: %s-triggered %s (mode2 command0) response disabled by AUTHNET_MODE2_COMMAND0_RESPONSE=%s",
    ...
    {
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: delaying %s-triggered %s (mode2 command0) %s response by %u ms",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
    ...
    AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s-triggered %s (mode2 command0) %s response status=%u preferred_realm_field=%u force_realm_list=%u plain=%s encrypted=%s",
        socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
...
void AuthnetSocket::SendMode2LoginFollowups(char const* trigger, bool forceRealmList)
{
    ...
    auto sendMode2EmptyCommand = [this, trigger](uint32 command, char const* responseMode, uint32 delayMs, bool& answered)
    {
        ...
        if (delayMs)
        {
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: delaying %s-triggered %s (mode2 command%u) %s response by %u ms",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
        ...
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s-triggered %s (mode2 command%u) %s response plain=%s encrypted=%s",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
    ...
    auto sendMode2Command6 = [this, trigger]()
    {
        ...
        {
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: delaying %s-triggered %s (mode2 command6) %s response by %u ms",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
        ...
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s-triggered %s (mode2 command6) %s response position=%s plain=%s encrypted=%s",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
    ...
    if (!_mode2Command2Answered && (forceRealmList || ShouldSendMode2Command2DetailProbe(command2Mode)))
    {
        ...
        {
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: delaying %s-triggered %s (mode2 command2) %s response by %u ms",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
        ...
        auto sendCommand2Detail = [this, trigger, command2Mode, preferredRealmField](AuthnetRealmRoute const* route)
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s-triggered %s (mode2 command2) %s response realm_id=%u realm=%s preferred_realm_field=%u plain=%s encrypted=%s",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
    ...
    if (!_mode2Command8Answered && ShouldSendMode2Command8StructuredProbe(command8Mode))
    {
        ...
        auto sendMode2Command8Status = [&](char const* position)
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s-triggered %s (mode2 command8) status %s response status=%u plain=%s encrypted=%s",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
        ...
        {
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: delaying %s-triggered %s (mode2 command8) %s response by %u ms",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
        ...
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s-triggered %s (mode2 command8) %s response field=%u list6=%u list18=%u force_realm_list=%u plain=%s encrypted=%s",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
        ...
        if (repeatCount && ShouldSendMode2Command8RepeatAsync())
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: scheduling asynchronous %s-triggered %s (mode2 command8) %s repeat count=%u delay_ms=%u",
                ...
                repeatCount, repeatDelayMs, repeatRealmField, repeatForceRealmList]()
            {
                for (uint32 repeatIndex = 0; repeatIndex < repeatCount; ++repeatIndex)
                {
                    ...
                    AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted asynchronous %s-triggered %s (mode2 command8) %s repeat %u/%u response field=%u list6=%u list18=%u force_realm_list=%u plain=%s encrypted=%s",
        ...
        else
        {
            for (uint32 repeatIndex = 0; repeatIndex < repeatCount; ++repeatIndex)
            {
                if (repeatDelayMs)
                {
                    AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: delaying %s-triggered %s (mode2 command8) repeat %u/%u by %u ms",
                        socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s-triggered %s (mode2 command8) %s repeat %u/%u response field=%u list6=%u list18=%u force_realm_list=%u plain=%s encrypted=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
        ...
        ShouldSendMode2Command8StructuredProbe(command8Mode))
    {
        ...
        for (uint32 repeatIndex = 0; repeatIndex < postCommand6Count; ++repeatIndex)
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: queued delayed %s-triggered %s (mode2 command8) %s post-command6 %u/%u response field=%u list6=%u list18=%u force_realm_list=%u plain=%s",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
            ...
            remotePort, command8ModeText, delayedRealmField, delayedForceRealmList]() mutable
        {
            ...
            for (uint32 i = 0; i < postCommand6Count; ++i)
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending delayed post-command6 %s (mode2 command8) %s response %u/%u delay_ms=%u gap_ms=%u field=%u list6=%u list18=%u force_realm_list=%u plain=%s encrypted=%s",
...
bool AuthnetSocket::TrySendPostLoginMode1Sequence(char const* trigger)
{
    ...
    if (delayMs || gapMs)
    {
        ...
        for (size_t i = 0; i < responses.size(); ++i)
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: queued encrypted %s-triggered post-login %s %s response %u/%u mode=%s delay_ms=%u gap_ms=%u status=%u field0=%u field1=%u value=%u plain=%s",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
            ...
            trigger, postLoginMode1ModeText, status, field0, field1, value]() mutable
        {
            ...
            for (size_t i = 0; i < responses.size(); ++i)
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending delayed encrypted %s-triggered post-login %s %s response %u/%u mode=%s delay_ms=%u gap_ms=%u status=%u field0=%u field1=%u value=%u plain=%s encrypted=%s",
    ...
    else
    {
        for (size_t i = 0; i < responses.size(); ++i)
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s-triggered post-login %s %s response %u/%u mode=%s delay_ms=%u gap_ms=%u status=%u field0=%u field1=%u value=%u plain=%s encrypted=%s",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), trigger,
                responseHeader.decoded ? AuthnetPacketName(responseHeader) : "UndecodedMode1Probe",
                responseLabels[i].c_str(), uint32(i + 1), uint32(responses.size()),
                postLoginMode1Mode, delayMs, gapMs, status, field0, field1, value,
...
void AuthnetSocket::ProcessEncryptedClientBytes(size_t encryptedFollowupOffset)
{
    ...
    AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: decrypted post-success byte(s) offset=%zu len=%zu plain=%s",
    ...
    auto handleResourceLookupPacket = [this](std::vector<uint8> const& packet, size_t packetOffset) -> bool
    {
        ...
        if (TryDecodeResourceLookup(packet, lookup))
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: localized resource lookup packet_offset=%zu id=%u marker=0x%08X parent=0x%08X optional=%u type=%u locale=%s variant=%u payload0=%s payload1=%s payload0_raw=0x%08X payload1_raw=0x%08X word=0x%04X remaining_bits=%zu packet_len=%zu bits=%zu",
            ...
            {
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: localized resource result id=%u disabled by AUTHNET_RESOURCE_RESULT_MODE=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            ...
            {
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: configured resource result id=%u decision=%s items=%u item_id=%u key=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
        ...
        {
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: decoded post-success request packet_offset=%zu id=%u",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), packetOffset, requestId);

            char const* resourceResultMode = GetResourceResultMode();
            if (IsResourceResultModeDisabled(resourceResultMode))
            {
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: post-success request id=%u result disabled by AUTHNET_RESOURCE_RESULT_MODE=%s",
    ...
    if (resourceLookupBytes != 0)
    {
        ...
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: decrypted post-success resource prefix packets=%u trailing_len=%zu trailing=%s",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(),
    ...
    if (header.decoded)
    {
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: decrypted post-success header name=%s command=%u mode_switch=%u mode=%u header_bits=%zu",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(),
        ...
        {
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: service request name=%s id=%u records=%zu selector=%u label_len=%zu nested_header=%s packet_len=%zu bits=%zu",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            ...
            for (size_t i = 0; i < serviceRequest.records.size(); ++i)
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: service request record[%u]=%s/%s minor=%u major=%u build=%u",
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: service result source id=%u found=%s record_index=%u/%zu record_mode=%s key_mode=%s key=%s blob_mode=%s blob=%s field80_mode=%s field80=%u source=%s/%s minor=%u major=%u build=%u",
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: service response mode=%s lookup_body=%s response_count=%zu",
            ...
            for (size_t i = 0; i < responses.size(); ++i)
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted service %s payload %zu/%zu id=%u plain=%s encrypted=%s",
            ...
            header.command == 0 && header.modeSwitch && header.mode == 1)
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s (mode1 command0) response plain=%s encrypted=%s",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            ...
            header.command == 0 && header.modeSwitch && header.mode == 2)
        {
            ...
            if (!_postLoginServiceResultSent && ShouldSendPostLoginServiceResult())
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted post-login %s (mode11 command3) id=%u field80=%u service_payload=%s plain=%s encrypted=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            ...
            if (!_postLoginStatusSent && TryGetPostLoginMode1Command1Status(postLoginStatus))
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted post-login %s (mode1 command1) status=%u plain=%s encrypted=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            ...
            header.command == 8 && header.modeSwitch && header.mode == 2)
        {
            ...
            if (StringEquals(responseMode, "none") || StringEquals(responseMode, "skip") ||
                StringEquals(responseMode, "off"))
            {
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: selected realm %s (mode2 command8) request observed; response disabled by AUTHNET_MODE2_COMMAND8_REQUEST_RESPONSE=%s plain=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            ...
            if (delayMs)
            {
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: delaying selected-realm %s (mode2 command8) %s response by %u ms",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            ...
            for (size_t i = 0; i < responses.size(); ++i)
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted selected-realm %s (mode2 command8) %s response %u/%u request=%s plain=%s encrypted=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            ...
            header.command == 6 && header.modeSwitch && header.mode == 1)
        {
            ...
            {
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: %s (mode1 command6) observed; response disabled by AUTHNET_MODE1_COMMAND6_RESPONSE=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
                ...
                StringEquals(responseMode, "mode2-realms") || StringEquals(responseMode, "mode2-followups"))
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: %s (mode1 command6) replaying realm-list sequence by AUTHNET_MODE1_COMMAND6_RESPONSE=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
                    AuthnetPacketName(1, 6, 1), responseMode);
            ...
            for (size_t i = 0; i < responses.size(); ++i)
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: sending encrypted %s (mode1 command6) %s response %u/%u status=%u field0=%u field1=%u value=%u plain=%s encrypted=%s",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
    ...
    {
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: decrypted post-success header undecoded len=%zu plain=%s",
...
void AuthnetSocket::TrySendProbeResponse(size_t readOffset, size_t readSize)
{
    ...
    if (LooksLikeHttpRequest(_captured))
    {
        if (CapturedStartsWith(_captured, "POST /patch "))
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: patch HTTP request received, sending local manifest pointer and closing",
                socket().getRemoteAddress().c_str(), socket().getRemotePort());
        ...
        if (CapturedStartsWith(_captured, "GET /manifest "))
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: manifest HTTP request received, sending local version info and closing",
                socket().getRemoteAddress().c_str(), socket().getRemotePort());
        ...
        if (TryGetHttpRequestTarget(_captured, target) && target.compare(0, 9, "/wow-pod/") == 0)
        {
            ...
            if (TryLoadLocalWowPodFile(target, body, filePath))
            {
                ...
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: local file request %s served from %s, %zu byte(s)",
                    socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            ...
            {
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: local file request %s not found",
        ...
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: HTTP request received on authnet port, sending empty HTTP response and closing",
            socket().getRemoteAddress().c_str(), socket().getRemotePort());
    ...
    if (!_responded)
    {
        std::vector<uint8> challenge = BuildNativePasswordChallenge(*_authnetSrp, *_authnetPasswordProof);
        std::vector<uint8> startupModuleKey;
        char const* startupModuleKeySource = "disabled";
        std::vector<uint8> response = BuildNativePasswordProofRequest(
            GetOrCreateStartupModuleKey(), challenge, &startupModuleKey, &startupModuleKeySource);

        AUTHNET_LOG_VERBOSE("'%s:%d' authnet authentication: sending native password proof request response=%zu module_count=2 module_key=%s module_key_source=%s challenge_bytes=%zu session_created=no.",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            response.size(),
            startupModuleKey.empty() ? "" : ByteArrayToHexStr(startupModuleKey).c_str(),
            startupModuleKeySource, challenge.size());

        socket().QueueSend(reinterpret_cast<char const*>(response.data()), response.size());
        _responded = true;
    }

    if (_authnetAuthenticationPending)
    {
        size_t const pendingBytes = _captured.size() - _initialRequestLen;
        NativeProofResponse proof;
        if (!TryDecodeNativeProofResponse(_captured.data() + _initialRequestLen, pendingBytes, proof))
            return;

        if (proof.modules.size() != 1 ||
            proof.modules[0].size() != 1 + SkyFire::Crypto::AuthnetSRP6::EPHEMERAL_KEY_LENGTH +
                SkyFire::Crypto::SHA256::DIGEST_LENGTH + SkyFire::Crypto::AuthnetSRP6::EPHEMERAL_KEY_LENGTH ||
            proof.modules[0][0] != 2)
        {
            SF_LOG_ERROR("server.authserver", "'%s:%d' authnet authentication: invalid native password proof shape modules=%zu bytes=%zu.",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), proof.modules.size(), proof.packetLength);
            socket().Close();
            return;
        }

        auto const& passwordProof = proof.modules[0];
        SkyFire::Crypto::AuthnetSRP6::EphemeralKey clientPublicValue;
        SkyFire::Crypto::AuthnetSRP6::Proof clientProof;
        SkyFire::Crypto::AuthnetPasswordProof::Value clientChallenge;
        std::copy_n(passwordProof.begin() + 1, clientPublicValue.size(), clientPublicValue.begin());
        std::copy_n(passwordProof.begin() + 1 + clientPublicValue.size(), clientProof.size(), clientProof.begin());
        std::copy_n(passwordProof.begin() + 1 + clientPublicValue.size() + clientProof.size(),
            clientChallenge.size(), clientChallenge.begin());

        std::optional<SkyFire::Crypto::AuthnetSRP6::SessionKey> sessionKey =
            _authnetSrp->VerifyChallengeResponse(clientPublicValue, clientProof);
        if (!sessionKey)
        {
            SF_LOG_ERROR("server.authserver", "'%s:%d' authnet authentication: native password proof rejected for account %u (%s).",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(),
        ...
        _authnetSecret = *sessionKey;
        SkyFire::Crypto::AuthnetSRP6::Proof const sessionVerifier =
            SkyFire::Crypto::AuthnetSRP6::GetSessionVerifier(clientPublicValue, clientProof, *sessionKey);
        SkyFire::Crypto::AuthnetPasswordProof::Value const serverSignature =
            _authnetPasswordProof->Sign(_authnetIdentity, clientChallenge);
        char const* moduleKeySource = nullptr;
        std::vector<uint8> moduleKey = BuildStartupModuleKey(GetOrCreateStartupModuleKey(), &moduleKeySource);
        std::vector<uint8> response = BuildNativePasswordAcceptedProofRequest(moduleKey, sessionVerifier, serverSignature);

        _initialRequestLen += proof.packetLength;
        _authnetAuthenticationPending = false;
        _authnetRiskFingerprintPending = true;

        AUTHNET_LOG_VERBOSE("'%s:%d' authnet authentication: native password proof accepted for account %u (%s); sending server proof response=%zu module_key_source=%s.",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(),
            _authnetAccountId, _authnetAccountName.c_str(), response.size(), moduleKeySource);
        socket().QueueSend(reinterpret_cast<char const*>(response.data()), response.size());

        AUTHNET_LOG_VERBOSE("'%s:%d' authnet authentication: waiting for native risk fingerprint proof.",
            socket().getRemoteAddress().c_str(), socket().getRemotePort());
    }

    if (_authnetRiskFingerprintPending)
    {
        while (_captured.size() >= _initialRequestLen + 2)
        {
            std::vector<uint8> candidate(_captured.begin() + _initialRequestLen,
                _captured.begin() + _initialRequestLen + 2);
            ProbePacketHeader header = DecodeProbePacketHeader(candidate);
            if (!header.decoded || header.command != 0 || !header.modeSwitch || header.mode != 1)
                break;

            _initialRequestLen += candidate.size();
            socket().QueueSend(reinterpret_cast<char const*>(candidate.data()), candidate.size());
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet authentication: answered cleartext connection ping while waiting for risk fingerprint.",
                socket().getRemoteAddress().c_str(), socket().getRemotePort());
        }
        ...
        if (proof.modules.size() != 1 || proof.modules[0].empty() || proof.modules[0][0] != 1)
        {
            SF_LOG_ERROR("server.authserver", "'%s:%d' authnet authentication: invalid risk fingerprint response modules=%zu bytes=%zu.",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(), proof.modules.size(), proof.packetLength);
            socket().Close();
            return;
        }
        ...
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet authentication: risk fingerprint accepted; sending native logon success response=%zu.",
            socket().getRemoteAddress().c_str(), socket().getRemotePort(), response.size());
        socket().QueueSend(reinterpret_cast<char const*>(response.data()), response.size());
    }

    while (!_clientModeSwitchSeen && _captured.size() >= _initialRequestLen + 2)
    {
        std::vector<uint8> candidate(_captured.begin() + _initialRequestLen,
            _captured.begin() + _initialRequestLen + 2);
        ProbePacketHeader header = DecodeProbePacketHeader(candidate);
        ...
        _initialRequestLen += candidate.size();
        socket().QueueSend(reinterpret_cast<char const*>(candidate.data()), candidate.size());
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet authentication: answered cleartext connection ping.",
            socket().getRemoteAddress().c_str(), socket().getRemotePort());
    }
    ...
    if (!_clientModeSwitchSeen && _captured.size() >= _initialRequestLen + ClientModeSwitchRequestLen)
    {
        ...
        if (header.decoded)
        {
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: client mode switch header name=%s command=%u mode_switch=%u mode=%u header_bits=%zu",
                socket().getRemoteAddress().c_str(), socket().getRemotePort(),
                AuthnetPacketName(header),
                header.command, header.modeSwitch, header.mode, header.bitPosition);
        }
        ...
        if (header.decoded && header.command == 5 && header.modeSwitch && header.mode == 1)
        {
            ...
            AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: client mode switch detected, waiting for encrypted follow-up",
                socket().getRemoteAddress().c_str(), socket().getRemotePort());
    ...
    if (!_followupLogged && _captured.size() >= encryptedFollowupOffset + FirstEncryptedFollowupLen)
    {
        ...
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: first encrypted post-success bytes detected: %s",
    ...
    if (_clientModeSwitchSeen && !_postSuccessBurstSeen)
    {
        ...
        if (encryptedFollowupBytes >= resourceLookupBurstBytes)
        {
            ...
            {
                AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: post-success lookup burst reached %zu byte(s), burst %s (mode2 command0) response disabled",
    ...
    {
        AUTHNET_LOG_VERBOSE("'%s:%d' authnet probe: post-success request length %zu observed after burst",
