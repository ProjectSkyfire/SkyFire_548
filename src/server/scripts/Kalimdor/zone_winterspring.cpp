...
public:
    ...
    struct npc_ranshallaAI : public npc_escortAI, private DialogueHelper
    {
        ...
        void DoSummonPriestess()
        {
            ...
            if (Creature* priestess = me->SummonCreature(NPC_PRIESTESS_ELUNE, wingThicketLocations[0].m_positionX, wingThicketLocations[0].m_positionY, wingThicketLocations[0].m_positionZ, wingThicketLocations[0].m_orientation, TempSummonType::TEMPSUMMON_CORPSE_DESPAWN, 0))
            {
            ...
            if (Creature* priestess = me->SummonCreature(NPC_PRIESTESS_ELUNE, wingThicketLocations[1].m_positionX, wingThicketLocations[1].m_positionY, wingThicketLocations[1].m_positionZ, wingThicketLocations[1].m_orientation, TempSummonType::TEMPSUMMON_CORPSE_DESPAWN, 0))
            {
        ...
        void JustDidDialogueStep(int32 entry) OVERRIDE
        {
            switch (entry)
            {
                ...
                case SAY_PRIESTESS_ALTAR_13:
                    ...
                    if (Creature* guard = me->SummonCreature(NPC_GUARDIAN_ELUNE, wingThicketLocations[2].m_positionX, wingThicketLocations[2].m_positionY, wingThicketLocations[2].m_positionZ, wingThicketLocations[2].m_orientation, TempSummonType::TEMPSUMMON_CORPSE_DESPAWN, 0))
                    {
                    ...
                    if (GameObject* altar = me->GetMap()->GetGameObject(_altarGUID))
                    {
                        if (Creature* voice = me->SummonCreature(NPC_VOICE_ELUNE, altar->GetPositionX(), altar->GetPositionY(), altar->GetPositionZ(), 0, TempSummonType::TEMPSUMMON_TIMED_DESPAWN, 30000))
