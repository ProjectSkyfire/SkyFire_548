...
EnumName<NPCFlags, int32> const npcFlagTexts[NPCFLAG_COUNT] =
{
    ...
    { UNIT_NPC_FLAG_WILDPET_CAPTURABLE, LANG_NPCINFO_WILDPET_CAPTURABLE },
    { UNIT_NPC_FLAG_BMAH,               LANG_NPCINFO_BMAUCTIONEER       },
};
...
public:
    ...
    */
    ...
    static bool HandleNpcSayCommand(ChatHandler* handler, char const* args)
    {
        ...
        creature->MonsterSay(args, Language::LANG_UNIVERSAL, NULL);
    ...
    static bool HandleNpcYellCommand(ChatHandler* handler, char const* args)
    {
        ...
        creature->MonsterYell(args, Language::LANG_UNIVERSAL, NULL);
