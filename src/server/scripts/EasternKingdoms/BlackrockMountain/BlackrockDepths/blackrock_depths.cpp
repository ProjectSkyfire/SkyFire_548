...
public:
    ...
    bool OnTrigger(Player* player, const AreaTriggerEntry* /*at*/) OVERRIDE
    {
        if (InstanceScript* instance = player->GetInstanceScript())
        {
            ...
            player->SummonCreature(NPC_GRIMSTONE, 625.559f, -205.618f, -52.735f, 2.609f, TempSummonType::TEMPSUMMON_DEAD_DESPAWN, 0);
...
public:
    ...
    struct npc_grimstoneAI : public npc_escortAI
    {
        ...
        void SummonRingMob()
        {
            if (Creature* tmp = me->SummonCreature(RingMob[MobSpawnId], 608.960f, -235.322f, -53.907f, 1.857f, TempSummonType::TEMPSUMMON_DEAD_DESPAWN, 0))
        ...
        void SummonRingBoss()
        {
            if (Creature* tmp = me->SummonCreature(RingBoss[rand()%6], 644.300f, -175.989f, -53.739f, 3.418f, TempSummonType::TEMPSUMMON_DEAD_DESPAWN, 0))
