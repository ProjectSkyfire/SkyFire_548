            ...
            void HandleOnHit()
            {
                if (Unit* elegon = GetCaster())
                {
                    if (Unit* target = GetHitUnit())
                    {
                        ...
                        if (m_spellInfo->Effects[EFFECT_0].MiscValue)
                            speedZ = float(m_spellInfo->Effects[EFFECT_0].MiscValue)/10;
                        else if (m_spellInfo->Effects[EFFECT_0].MiscValueB)
                            speedZ = float(m_spellInfo->Effects[EFFECT_0].MiscValueB)/10;
                        else
                            speedZ = 10.0f;
