    ...
    public :
        ...
        void JustDied(Unit* killer)
        {
            if(instance) 
            {
                ...
                if(GameObject* exit = ObjectAccessor::GetGameObject(*me, instance->GetData64(INSTANCE_DATA64_OOK_OOK_EXIT_GUID)))
...
public:
    ...
    bool OnCheck(Player *source, Unit *target)
    {
        ...
        if(target && target->GetTypeId() != TYPEID_PLAYER
                ...
                && target->GetMap()->GetDifficulty() == DUNGEON_DIFFICULTY_HEROIC)
        {
