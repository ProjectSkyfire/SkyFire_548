...
<body>
    <header><a href="/" class="brand"><?= htmlspecialchars($brand, ENT_QUOTES, 'UTF-8') ?></a><span>Cluster control</span><button id="logout" hidden>Sign out</button></header>
    <main>
        ...
        <div id="workspace" hidden>
            ...
            <div class="content">
                <div class="heading"><div><p class="eyebrow">Live directory</p><h1>Your cluster</h1></div><span id="updated" class="muted"></span></div>
