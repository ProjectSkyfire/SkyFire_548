...
DELETE FROM `rbac_permissions` WHERE `id`=894;
INSERT INTO `rbac_permissions` (`id`, `name`) VALUES (894, 'Command: .account 2fa');
DELETE FROM `rbac_permissions` WHERE `id`=895;
INSERT INTO `rbac_permissions` (`id`, `name`) VALUES (895, 'Command: .account 2fa setup');
DELETE FROM `rbac_permissions` WHERE `id`=896;
INSERT INTO `rbac_permissions` (`id`, `name`) VALUES (896, 'Command: .account 2fa remove');
DELETE FROM `rbac_permissions` WHERE `id`=897;
INSERT INTO `rbac_permissions` (`id`, `name`) VALUES (897, 'Command: .account set 2fa <account> <secret/off>');

DELETE FROM `rbac_linked_permissions` WHERE `id`=195 AND `linkedId`=894;
INSERT INTO `rbac_linked_permissions` (`id`, `linkedId`) VALUES (195, 894);
DELETE FROM `rbac_linked_permissions` WHERE `id`=195 AND `linkedId`=895;
INSERT INTO `rbac_linked_permissions` (`id`, `linkedId`) VALUES (195, 895);
DELETE FROM `rbac_linked_permissions` WHERE `id`=195 AND `linkedId`=896;
INSERT INTO `rbac_linked_permissions` (`id`, `linkedId`) VALUES (195, 896);
DELETE FROM `rbac_linked_permissions` WHERE `id`=192 AND `linkedId`=897;
INSERT INTO `rbac_linked_permissions` (`id`, `linkedId`) VALUES (192, 897);
