...
('account 2fa', 894, 'Syntax: .account 2fa <setup/remove>'),
('account 2fa setup', 895, 'Syntax: .account 2fa setup
Sets up two-factor authentication for this account.'),
('account 2fa remove', 896, 'Syntax: .account 2fa remove <token>
Disables two-factor authentication for this account, if enabled.'),
('account set 2fa', 897, 'Syntax: .account set 2fa <account> <secret/off>
...
DELETE FROM `skyfire_string` WHERE `entry` BETWEEN 87 AND 95;
DELETE FROM `skyfire_string` WHERE `entry` BETWEEN 188 AND 190;
