...
UPDATE `creature_template` SET `AIName` = 'SmartAI', `spell1` = @FIREBOLT WHERE `entry` = @ENTRY;
...
@ENTRY, 0, 0, 0, 0, 0, 100, 
0, 0, 0, 3400, 4800, 
11, @FIREBOLT, 1, 0, 0, 0, 0, 
2, 0, 0, 0, 0, 0, 0, 0, 'Gug Fatcandle - In Combat - Cast Firebolt');